# BMOPF Network Summary: network_4 / Feeder_1

**Generated:** 2026-07-01 13:29:20  
**Findings:** 0 errors · 3 warnings · 82 info  
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000259 | 0.00135 | 0.627 | 4 |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 375 / 375 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 375 |
| Neutral branches | 374 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 375 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
**Total findings:** 85 (0 errors, 3 warnings, 82 info)
