...
**Findings:** 0 errors · 4 warnings · 38 info  
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 131 / 131 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 131 |
| Neutral branches | 130 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
**Total findings:** 42 (0 errors, 4 warnings, 38 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line8`  
  Line 'line8' has ||Z||_F = 9.44e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
