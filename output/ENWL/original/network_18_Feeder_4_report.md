# BMOPF Network Summary: network_18 / Feeder_4

**Generated:** 2026-06-23 21:28:00  
**Findings:** 0 errors · 6 warnings · 86 info  
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000581 | 0.00228 | 0.722 | 4 |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 1163 / 1163 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 1163 |
| Neutral branches | 1162 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 1163 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
**Total findings:** 92 (0 errors, 6 warnings, 86 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line629`  
  Line 'line629' has ||Z||_F = 8.7e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line868`  
  Line 'line868' has ||Z||_F = 9.37e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line1019`  
  Line 'line1019' has ||Z||_F = 8.91e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
