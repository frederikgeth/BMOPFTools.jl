# BMOPF Network Summary: network_18_Feeder_4
...
| generator | 10 | capacity: 207.108 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Total gen capacity | 207.108 kW |
| Generation/load ratio | 726.2% |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 73 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 72 / 0 / 0 |
