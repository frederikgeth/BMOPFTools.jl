# BMOPF Network Summary: network_17_Feeder_1

**Generated:** 2026-06-23 13:43:18  
...
|-------|---------|------:|------:|------:|-----------:|
| LV_240V | 240.0 V | 376 | 375 | 188 | 48 |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| p_max | 4000.0 | 327000.0 | 3.315 | 50 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.49 | 79.9 | 0.88 | 375 |
...
| Total gen capacity | 1.17 MW |
| Generation/load ratio | 714.9% |
...
| Buses without voltage bounds | 376 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 376 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 376 / 376 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 376 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 376 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 375 / 0 / 0 |
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  376 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
