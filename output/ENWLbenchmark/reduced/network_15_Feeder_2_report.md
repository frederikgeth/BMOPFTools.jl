# BMOPF Network Summary: network_15_Feeder_2
...
| generator | 28 | capacity: 690.394 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
|-------|---------|------:|------:|------:|-----------:|
| LV_240V | 240.0 V | 191 | 190 | 107 | 28 |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| p_max | 4000.0 | 194000.0 | 2.521 | 30 |
...
| Total gen capacity | 690.394 kW |
| Generation/load ratio | 711.3% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 191 / 191 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 191 |
| Neutral branches | 190 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 191 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 190 / 0 / 0 |
