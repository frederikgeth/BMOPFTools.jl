# BMOPF Network Summary: network_7_Feeder_1

**Generated:** 2026-06-23 13:44:13  
**Findings:** 0 errors · 6 warnings · 110 info  
...
| generator | 19 | capacity: 435.485 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
|-------|---------|------:|------:|------:|-----------:|
| LV_240V | 240.0 V | 1022 | 1021 | 71 | 19 |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| p_max | 4000.0 | 121000.0 | 2.026 | 21 |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000322 | 0.00228 | 0.712 | 6 |
...
| Total gen capacity | 435.485 kW |
| Generation/load ratio | 718.8% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 1022 / 1022 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 1022 |
| Neutral branches | 1021 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 1022 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 1021 / 0 / 0 |
...
**Total findings:** 116 (0 errors, 6 warnings, 110 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line854`  
  Line 'line854' has ||Z||_F = 6.29e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line833`  
  Line 'line833' has ||Z||_F = 9.96e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line843`  
  Line 'line843' has ||Z||_F = 8.59e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
