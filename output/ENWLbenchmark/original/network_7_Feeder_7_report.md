# BMOPF Network Summary: network_7_Feeder_7

**Generated:** 2026-06-23 13:44:16  
**Findings:** 0 errors · 4 warnings · 41 info  
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 349 / 349 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 349 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 349 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 348 / 0 / 0 |
...
**Total findings:** 45 (0 errors, 4 warnings, 41 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line17`  
  Line 'line17' has ||Z||_F = 9.56e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
