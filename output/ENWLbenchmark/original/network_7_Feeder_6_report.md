# BMOPF Network Summary: network_7_Feeder_6

**Generated:** 2026-06-23 13:44:16  
**Findings:** 0 errors · 6 warnings · 39 info  
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000756 | 0.00228 | 0.554 | 4 |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 216 / 216 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 216 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 216 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 215 / 0 / 0 |
...
**Total findings:** 45 (0 errors, 6 warnings, 39 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line18`  
  Line 'line18' has ||Z||_F = 9.81e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line16`  
  Line 'line16' has ||Z||_F = 9.64e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line19`  
  Line 'line19' has ||Z||_F = 8.7e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
