# BMOPF Network Summary: network_1_Feeder_3

**Generated:** 2026-06-23 13:43:42  
**Findings:** 0 errors · 3 warnings · 48 info  
...
| generator | 11 | capacity: 280.559 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000259 | 0.00228 | 0.672 | 5 |
...
| Total gen capacity | 280.559 kW |
| Generation/load ratio | 699.8% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 505 / 505 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 505 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 505 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 504 / 0 / 0 |
...
**Total findings:** 51 (0 errors, 3 warnings, 48 info)
