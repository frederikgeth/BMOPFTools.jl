# BMOPF Network Summary: network_18_Feeder_2

**Generated:** 2026-06-23 13:43:33  
**Findings:** 0 errors · 5 warnings · 155 info  
...
| generator | 7 | capacity: 162.42 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000564 | 0.00228 | 0.697 | 5 |
...
| Total gen capacity | 162.42 kW |
| Generation/load ratio | 704.0% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 991 / 991 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 991 |
| Neutral branches | 990 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 991 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 990 / 0 / 0 |
...
**Total findings:** 160 (0 errors, 5 warnings, 155 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line670`  
  Line 'line670' has ||Z||_F = 9.42e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line204`  
  Line 'line204' has ||Z||_F = 8.22e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
