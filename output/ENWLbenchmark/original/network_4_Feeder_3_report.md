# BMOPF Network Summary: network_4_Feeder_3

**Generated:** 2026-06-23 13:44:02  
**Findings:** 0 errors · 9 warnings · 41 info  
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 265 / 265 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 265 |
| Neutral branches | 264 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 265 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 264 / 0 / 0 |
...
**Total findings:** 50 (0 errors, 9 warnings, 41 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line56`  
  Line 'line56' has ||Z||_F = 9.69e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line54`  
  Line 'line54' has ||Z||_F = 5.9e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line58`  
  Line 'line58' has ||Z||_F = 3.58e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line55`  
  Line 'line55' has ||Z||_F = 4.76e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line53`  
  Line 'line53' has ||Z||_F = 3.1e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line57`  
  Line 'line57' has ||Z||_F = 5.57e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
