...
| Buses without voltage bounds | 100 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 100 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 100 | ≤3-wire | solid | 0 | indeterminate (3-wire / Kron-style implicit grounding) |
