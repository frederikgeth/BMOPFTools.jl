...
**Findings:** 0 errors · 5 warnings · 15 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 141 | ≤3-wire | solid | 0 | indeterminate (3-wire / Kron-style implicit grounding) |
...
> 🟡 **[W.INT.LOW_IMPEDANCE_LINE]** 1 line(s) have total series impedance below 10⁻³× the network median — they degrade NLP conditioning; model them as lossless switches: line145.
...
**Total findings:** 20 (0 errors, 5 warnings, 15 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line1086`  
  Line 'line1086' has ||Z||_F = 7.92e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
...
- **[W.INT.LOW_IMPEDANCE_LINE]** `line`  
  1 line(s) have total series impedance below 10⁻³× the network median — they degrade NLP conditioning; model them as lossless switches: line145.
...
- **[I.DOM.LINE_IMPEDANCE_SPREAD]** `line`  
  Adjacent lines 'line151' and 'line145' at bus '146' have ||Z||_F ratio 3670.0× — large impedance contrasts between neighbouring lines cause ill-conditioned KKT Jacobians; consider per-unit scaling or network reformulation.
- **[I.RED.MERGEABLE_LINES]** `line`  
  9 group(s) of series lines (18 lines total) can be merged — intermediate buses have no other connections.
