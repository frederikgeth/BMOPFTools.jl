...
> 🔵 **[I.DIV.LINE_SYMMETRIC]** 5 lines share linecode 'lc1' with similar length (±10%) — electrically near-identical.
...
- **[I.DIV.LINE_SYMMETRIC]** `line`  
  5 lines share linecode 'lc1' with similar length (±10%) — electrically near-identical.
