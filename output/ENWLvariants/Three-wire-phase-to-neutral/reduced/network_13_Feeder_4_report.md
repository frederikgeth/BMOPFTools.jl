...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 178 | ≤3-wire | solid | 0 | indeterminate (3-wire / Kron-style implicit grounding) |
...
- **[I.RED.UNUSED_LINECODES]** `linecode`  
  5 linecode(s) defined but not referenced by any line.
