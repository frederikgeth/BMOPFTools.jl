...
**Findings:** 0 errors · 31 warnings · 78 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 320 | ≤3-wire | solid | 0 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 109 (0 errors, 31 warnings, 78 info)
