...
| Buses without voltage bounds | 51 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 51 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 51 | ≤3-wire | solid | 23 | indeterminate (3-wire / Kron-style implicit grounding) |
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  51 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
