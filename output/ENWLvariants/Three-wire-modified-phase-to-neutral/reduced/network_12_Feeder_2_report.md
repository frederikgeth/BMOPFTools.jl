...
**Findings:** 0 errors · 1 warnings · 13 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 166 | ≤3-wire | solid | 83 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 14 (0 errors, 1 warnings, 13 info)
