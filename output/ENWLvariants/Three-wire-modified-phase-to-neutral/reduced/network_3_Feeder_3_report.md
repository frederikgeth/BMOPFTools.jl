# BMOPF Network Summary: Three-wire-modified-phase-to-neutral / network_3 / Feeder_3
...
| Buses without voltage bounds | 207 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 207 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 207 | ≤3-wire | solid | 100 | indeterminate (3-wire / Kron-style implicit grounding) |
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  207 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
