...
| Buses without voltage bounds | 102 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 102 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 102 | ≤3-wire | solid | 49 | indeterminate (3-wire / Kron-style implicit grounding) |
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  102 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
