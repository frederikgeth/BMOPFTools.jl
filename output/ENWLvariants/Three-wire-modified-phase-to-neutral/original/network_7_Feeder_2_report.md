# BMOPF Network Summary: Three-wire-modified-phase-to-neutral / network_7 / Feeder_2
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000517 | 0.00455 | 0.805 | 7 |
...
> 🔵 **[I.PROV.IMPEDANCE_TRANSFORM_MPN]** 7 three-wire linecode(s) match the impedance signature of modified phase-to-neutral approximation — both R and X blocks are circulant with mutual ≈ ½ self. X is further symmetrised relative to the standard phase-to-neutral form, introducing additional modelling error particularly for asymmetric cable geometries.: LC2, LC3, LC4, LC5, LC6, LC7, LC8.
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `LINE256`  
  Line 'LINE256' has ||Z||_F = 1.46e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
