# BMOPF Network Summary: Three-wire-modified-phase-to-neutral / network_3 / Feeder_1

**Generated:** 2026-06-23 21:00:29  
**Findings:** 0 errors · 5 warnings · 49 info  
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.00113 | 0.00455 | 0.565 | 6 |
...
> 🔵 **[I.PROV.IMPEDANCE_TRANSFORM_MPN]** 6 three-wire linecode(s) match the impedance signature of modified phase-to-neutral approximation — both R and X blocks are circulant with mutual ≈ ½ self. X is further symmetrised relative to the standard phase-to-neutral form, introducing additional modelling error particularly for asymmetric cable geometries.: LC1, LC2, LC3, LC4, LC5, LC6.
...
**Total findings:** 54 (0 errors, 5 warnings, 49 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `LINE1274`  
  Line 'LINE1274' has ||Z||_F = 6.61e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `LINE1275`  
  Line 'LINE1275' has ||Z||_F = 6.61e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
