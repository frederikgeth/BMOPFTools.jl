# BMOPF Network Summary: Three-wire-modified-phase-to-neutral / network_4 / Feeder_4

**Generated:** 2026-07-01 13:32:54  
**Findings:** 0 errors · 2 warnings · 46 info  
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000517 | 0.00455 | 0.695 | 6 |
...
> 🔵 **[I.PROV.IMPEDANCE_TRANSFORM_MPN]** 6 three-wire linecode(s) match the impedance signature of modified phase-to-neutral approximation — both R and X blocks are circulant with mutual ≈ ½ self. X is further symmetrised relative to the standard phase-to-neutral form, introducing additional modelling error particularly for asymmetric cable geometries.: lc1, lc2, lc4, lc5, lc6, lc8.
...
**Total findings:** 48 (0 errors, 2 warnings, 46 info)
