# BMOPF Network Summary: Three-wire-modified-phase-to-neutral / network_16 / Feeder_2

**Generated:** 2026-06-23 21:31:17  
**Findings:** 0 errors · 3 warnings · 36 info  
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.00113 | 0.00455 | 0.648 | 5 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 1077 | ≤3-wire | solid | 0 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 39 (0 errors, 3 warnings, 36 info)
