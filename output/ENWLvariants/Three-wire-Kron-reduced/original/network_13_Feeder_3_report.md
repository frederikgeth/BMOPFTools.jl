...
**Findings:** 0 errors · 17 warnings · 58 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 108 | ≤3-wire | solid | 2 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 75 (0 errors, 17 warnings, 58 info)
