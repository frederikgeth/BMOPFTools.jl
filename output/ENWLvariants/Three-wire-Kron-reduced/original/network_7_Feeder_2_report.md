...
**Findings:** 0 errors · 33 warnings · 101 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 605 | ≤3-wire | solid | 58 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 134 (0 errors, 33 warnings, 101 info)
