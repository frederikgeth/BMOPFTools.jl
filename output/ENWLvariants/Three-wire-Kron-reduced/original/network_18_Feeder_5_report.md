...
**Findings:** 0 errors · 79 warnings · 153 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 984 | ≤3-wire | solid | 0 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 232 (0 errors, 79 warnings, 153 info)
