# BMOPF Network Summary: Three-wire-Kron-reduced / network_5 / Feeder_1

**Generated:** 2026-06-23 21:30:09  
**Findings:** 0 errors · 10 warnings · 41 info  
...
|-----------|-----|-----|----|---|
| p_nom | 306.0 | 2940.0 | 0.937 | 4 |
| q_nom | 101.0 | 966.0 | 0.937 | 4 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.03 | 13.4 | 1.77 | 130 |
...
> 🔵 **[I.DIV.LOAD_UNIFORM_MODEL]** All 4 loads use the constant_power model — no load exercises voltage dependence (ZIP/exponential); the case does not test voltage-dependent load behaviour.
> 🔵 **[I.DIV.LOAD_UNIFORM_CONFIG]** All 4 loads share the 'SINGLE_PHASE' configuration — no connection diversity.

## 5. Loading & Operational Summary

| | Value |
|--|-------|
| Total load P | 5.538 kW |
| Total load Q | 1.8 kvar |
...
| Buses without voltage bounds | 131 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 131 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
**Total findings:** 51 (0 errors, 10 warnings, 41 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line8`  
  Line 'line8' has ||Z||_F = 5.1e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line6`  
  Line 'line6' has ||Z||_F = 7.38e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line3`  
  Line 'line3' has ||Z||_F = 9.34e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line2`  
  Line 'line2' has ||Z||_F = 8.23e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
...
- **[I.DIV.LOAD_UNIFORM_MODEL]** `load`  
  All 4 loads use the constant_power model — no load exercises voltage dependence (ZIP/exponential); the case does not test voltage-dependent load behaviour.
