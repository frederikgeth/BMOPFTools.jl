...
**Findings:** 0 errors · 27 warnings · 73 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 506 | ≤3-wire | solid | 31 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 100 (0 errors, 27 warnings, 73 info)
