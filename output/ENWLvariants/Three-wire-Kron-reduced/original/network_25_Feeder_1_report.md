...
**Findings:** 0 errors · 130 warnings · 259 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 532 | ≤3-wire | solid | 11 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 389 (0 errors, 130 warnings, 259 info)
