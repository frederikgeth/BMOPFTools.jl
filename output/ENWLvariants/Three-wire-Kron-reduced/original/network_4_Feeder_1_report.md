...
**Findings:** 0 errors · 31 warnings · 96 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 375 | ≤3-wire | solid | 24 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 127 (0 errors, 31 warnings, 96 info)
