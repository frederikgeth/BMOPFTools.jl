...
**Findings:** 0 errors · 51 warnings · 145 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 844 | ≤3-wire | solid | 67 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 196 (0 errors, 51 warnings, 145 info)
