...
**Findings:** 0 errors · 43 warnings · 87 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 458 | ≤3-wire | solid | 30 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 130 (0 errors, 43 warnings, 87 info)
