...
**Findings:** 0 errors · 25 warnings · 144 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 780 | ≤3-wire | solid | 26 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 169 (0 errors, 25 warnings, 144 info)
