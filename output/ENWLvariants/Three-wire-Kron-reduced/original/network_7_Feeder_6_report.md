...
**Findings:** 0 errors · 36 warnings · 50 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 216 | ≤3-wire | solid | 0 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 86 (0 errors, 36 warnings, 50 info)
