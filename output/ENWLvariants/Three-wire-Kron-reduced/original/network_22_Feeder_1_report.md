...
**Findings:** 0 errors · 21 warnings · 102 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 688 | ≤3-wire | solid | 31 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 123 (0 errors, 21 warnings, 102 info)
