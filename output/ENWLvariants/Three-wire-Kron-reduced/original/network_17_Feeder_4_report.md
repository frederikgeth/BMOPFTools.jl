...
**Findings:** 0 errors · 37 warnings · 122 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 1535 | ≤3-wire | solid | 106 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 159 (0 errors, 37 warnings, 122 info)
