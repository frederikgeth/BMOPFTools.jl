...
**Findings:** 0 errors · 45 warnings · 101 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 622 | ≤3-wire | solid | 0 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 146 (0 errors, 45 warnings, 101 info)
