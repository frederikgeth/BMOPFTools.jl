...
**Findings:** 0 errors · 27 warnings · 72 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 472 | ≤3-wire | solid | 39 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 99 (0 errors, 27 warnings, 72 info)
