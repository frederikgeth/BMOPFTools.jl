...
**Findings:** 0 errors · 13 warnings · 51 info  
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 505 | ≤3-wire | solid | 39 | indeterminate (3-wire / Kron-style implicit grounding) |
...
**Total findings:** 64 (0 errors, 13 warnings, 51 info)
