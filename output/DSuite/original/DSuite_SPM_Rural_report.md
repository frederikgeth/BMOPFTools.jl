...
**Findings:** 0 errors · 11 warnings · 33 info  
...
| Buses without voltage bounds | 70 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 70 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
| 242.0 V | 68 | ≤3-wire | solid | 41 | indeterminate (3-wire / Kron-style implicit grounding) |
...
> 🔵 **[I.PROV.DSS_DEFAULT_LENGTH]** 1 of 68 line(s) have length exactly 1.0 among otherwise varied lengths — the OpenDSS default; these lengths were likely never set.
...
> 🔵 **[I.PROV.LINE_SWITCH_LIKE]** Line '7169887' has near-zero series impedance and may be modelled more accurately as a switch: effective impedance (Z·length) < 0.0001 Ω on all diagonals.
...
> 🔵 **[I.PROV.LINE_SWITCH_LIKE]** Line '7169889' has near-zero series impedance and may be modelled more accurately as a switch: effective impedance (Z·length) < 0.0001 Ω on all diagonals.
> 🔵 **[I.PROV.LINE_SWITCH_LIKE]** Line '7169890' has near-zero series impedance and may be modelled more accurately as a switch: effective impedance (Z·length) < 0.0001 Ω on all diagonals.
...
> 🟡 **[W.INT.LOW_IMPEDANCE_LINE]** 5 line(s) have total series impedance below 10⁻³× the network median — they degrade NLP conditioning; model them as lossless switches: 11628671, 7169887, 7169888, 7169889, 7169890.
...
**Total findings:** 44 (0 errors, 11 warnings, 33 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `7169890`  
  Line '7169890' has ||Z||_F = 7.3e-8 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `7169888`  
  Line '7169888' has ||Z||_F = 3.7e-7 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `7169887`  
  Line '7169887' has ||Z||_F = 1.06e-7 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `7169889`  
  Line '7169889' has ||Z||_F = 1.59e-7 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_IMPEDANCE_SPREAD]** `line`  
  Adjacent lines '7169890' and '468841' at bus '17582384' have ||Z||_F ratio 417000.0× — large impedance contrasts between neighbouring lines cause ill-conditioned KKT Jacobians; consider per-unit scaling or network reformulation.
- **[W.RED.ZERO_LOADS]** `load`  
  21 load(s) have p_nom=0 and q_nom=0 — electrically inert.
- **[W.INT.LOW_IMPEDANCE_LINE]** `line`  
  5 line(s) have total series impedance below 10⁻³× the network median — they degrade NLP conditioning; model them as lossless switches: 11628671, 7169887, 7169888, 7169889, 7169890.
...
- **[I.PROV.DSS_DEFAULT_LENGTH]** `line`  
  1 of 68 line(s) have length exactly 1.0 among otherwise varied lengths — the OpenDSS default; these lengths were likely never set.
...
- **[I.PROV.LINE_SWITCH_LIKE]** `7169887`  
  Line '7169887' has near-zero series impedance and may be modelled more accurately as a switch: effective impedance (Z·length) < 0.0001 Ω on all diagonals.
...
- **[I.PROV.LINE_SWITCH_LIKE]** `7169889`  
  Line '7169889' has near-zero series impedance and may be modelled more accurately as a switch: effective impedance (Z·length) < 0.0001 Ω on all diagonals.
- **[I.PROV.LINE_SWITCH_LIKE]** `7169890`  
  Line '7169890' has near-zero series impedance and may be modelled more accurately as a switch: effective impedance (Z·length) < 0.0001 Ω on all diagonals.
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  70 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
