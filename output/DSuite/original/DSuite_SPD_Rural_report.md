...
**Generated:** 2026-06-23 21:26:47  
**Findings:** 0 errors · 10 warnings · 34 info  
...
| 242.0 V | 64 | ≤3-wire | none | 0 | IT (isolated / high-impedance earthed) |
...
> 🔵 **[I.PROV.DSS_DEFAULT_LENGTH]** 1 of 65 line(s) have length exactly 1.0 among otherwise varied lengths — the OpenDSS default; these lengths were likely never set.
...
**Total findings:** 44 (0 errors, 10 warnings, 34 info)
...
- **[I.PROV.DSS_DEFAULT_LENGTH]** `line`  
  1 of 65 line(s) have length exactly 1.0 among otherwise varied lengths — the OpenDSS default; these lengths were likely never set.
