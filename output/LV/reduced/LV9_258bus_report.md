...
**Findings:** 0 errors · 3 warnings · 23 info  
...
| Buses without voltage bounds | 189 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 189 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 188 / 188 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 189 |
| Neutral branches | 187 |
...
**Total findings:** 26 (0 errors, 3 warnings, 23 info)
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  189 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
