...
| Buses without voltage bounds | 214 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 214 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 213 / 213 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 214 |
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  214 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
