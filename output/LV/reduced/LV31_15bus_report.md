...
**Findings:** 0 errors · 1 warnings · 22 info  
...
| Buses without voltage bounds | 6 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 6 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
**Total findings:** 23 (0 errors, 1 warnings, 22 info)
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  6 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
