...
| Buses without voltage bounds | 142 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 142 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 141 / 141 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 142 |
| Neutral branches | 140 |
| Grounding points | 96 |
| Neutral sections | 2 |
| Floating sections | 0 |
...
**Total findings:** 25 (0 errors, 3 warnings, 22 info)
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  142 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
