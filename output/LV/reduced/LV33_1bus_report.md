...
| Max degree | 1 |
| Degree-1 buses | 2 |
| Tree depth (max hops) | 0 |

> 🔴 **[E.CONN.DISCONNECTED]** Network has 2 disconnected components.
...
**Inferred convention:** MV_6.4kV: 4-wire; implicit (Kron-style) grounding
...
| ? | 1 | ≤3-wire | none | 0 | isolated |
| ? | 1 | 4-wire | solid | 0 | solidly earthed |
...
| Dimension issues | 0 |
| Galvanic islands | 3 |
| Islands without voltage reference | 1 |
