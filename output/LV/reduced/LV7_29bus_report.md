...
|-----------|-----|-----|----|---|
| p_nom | 10000.0 | 10000.0 | 0.0 | 5 |
| q_nom | 5400.0 | 5400.0 | 0.0 | 5 |

### line ⚠

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.396 | 69.3 | 0.974 | 12 |
...
> 🟡 **[W.DIV.LOAD_SYMMETRIC]** 4 of 5 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
> 🔵 **[I.DIV.LINE_SYMMETRIC]** 3 lines share linecode 'ughv_400al_triplex_ug_4w_bundled' with similar length (±10%) — electrically near-identical.

## 5. Loading & Operational Summary

| | Value |
|--|-------|
| Total load P | 50.0 kW |
| Total load Q | 27.0 kvar |
...
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b2407' has no load connected to phase terminal 'a'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b2407' has no load connected to phase terminal 'b'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b2407' has no load connected to phase terminal 'c'.
...
**Inferred convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 7 grounding point(s)

| Voltage level | Wires | Buses with neutral |
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 13 / 13 |
...
> 🔵 **[I.PROV.DSS_DEFAULT_PF]** 5 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[W.DIV.LOAD_SYMMETRIC]** `load`  
  4 of 5 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
- **[I.DIV.LINE_SYMMETRIC]** `line`  
  3 lines share linecode 'ughv_400al_triplex_ug_4w_bundled' with similar length (±10%) — electrically near-identical.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b2407' has no load connected to phase terminal 'a'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b2407' has no load connected to phase terminal 'b'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b2407' has no load connected to phase terminal 'c'.
...
- **[I.PROV.DSS_DEFAULT_PF]** `load`  
  5 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
