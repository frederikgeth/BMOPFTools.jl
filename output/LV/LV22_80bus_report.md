...
| q_nom | 5000.0 | 5000.0 | 0.0 | 21 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.0748 | 195.0 | 1.246 | 71 |
...
- **[I.RED.UNUSED_LINECODES]** `linecode`  
  16 linecode(s) defined but not referenced by any line.
