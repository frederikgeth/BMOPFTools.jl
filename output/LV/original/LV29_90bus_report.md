...
|-----------|-----|-----|----|---|
| p_nom | 10000.0 | 10000.0 | 0.0 | 41 |
| q_nom | 5400.0 | 5400.0 | 0.0 | 41 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.0669 | 54.1 | 0.858 | 82 |
...
> 🟡 **[W.DIV.LOAD_SYMMETRIC]** 40 of 41 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
> 🔵 **[I.DIV.LOAD_UNIFORM_MODEL]** All 41 loads use the constant_power model — no load exercises voltage dependence (ZIP/exponential); the case does not test voltage-dependent load behaviour.
> 🔵 **[I.DIV.LOAD_UNIFORM_CONFIG]** All 41 loads share the 'SINGLE_PHASE' configuration — no connection diversity.

## 5. Loading & Operational Summary

| | Value |
|--|-------|
| Total load P | 410.0 kW |
| Total load Q | 221.3 kvar |
...
> 🟡 **[W.OPS.IMPORT_DEPENDENT]** Network is heavily import-dependent: local generation capacity (0.0 MW) is less than 5% of total load (0.41 MW).
> 🟡 **[W.OPS.XFMR_OVERLOADED]** Transformer 'tx2615' is at 147.9% utilisation at nominal load — little OPF headroom.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b2700' has no load connected to phase terminal 'a'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b2700' has no load connected to phase terminal 'b'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b2700' has no load connected to phase terminal 'c'.
...
| Buses without voltage bounds | 91 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 91 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
> 🔵 **[I.PRE.SINGLE_SOURCE]** Network has a single voltage source — single point of failure. Infeasibility of the source makes the entire network infeasible.

## 7. Provenance & Model Conventions

**Inferred convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 43 grounding point(s)

| Voltage level | Wires | Buses with neutral |
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 90 / 90 |
...
**OpenDSS default fingerprints:** 41 hit(s) — see findings
...
> 🔵 **[I.PROV.DSS_DEFAULT_PF]** 41 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[W.DIV.LOAD_SYMMETRIC]** `load`  
  40 of 41 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
- **[I.DIV.LOAD_UNIFORM_MODEL]** `load`  
  All 41 loads use the constant_power model — no load exercises voltage dependence (ZIP/exponential); the case does not test voltage-dependent load behaviour.
- **[I.DIV.LOAD_UNIFORM_CONFIG]** `load`  
  All 41 loads share the 'SINGLE_PHASE' configuration — no connection diversity.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b2700' has no load connected to phase terminal 'a'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b2700' has no load connected to phase terminal 'b'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b2700' has no load connected to phase terminal 'c'.
...
- **[I.PROV.DSS_DEFAULT_PF]** `load`  
  41 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  91 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
