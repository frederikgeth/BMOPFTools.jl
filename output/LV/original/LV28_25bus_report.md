...
|-----------|-----|-----|----|---|
| p_nom | 10000.0 | 10000.0 | 0.0 | 3 |
| q_nom | 5400.0 | 5400.0 | 0.0 | 3 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.2 | 155.0 | 1.407 | 21 |
...
| | Value |
|--|-------|
| Total load P | 30.0 kW |
| Total load Q | 16.2 kvar |
...
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b598' has no load connected to phase terminal 'a'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b598' has no load connected to phase terminal 'b'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b598' has no load connected to phase terminal 'c'.
...
**Inferred convention:** MV_6.4kV: 4-wire; LV_240V: 4-wire; 5 grounding point(s)
...
> 🔵 **[I.PROV.DSS_DEFAULT_PF]** 3 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
**Total findings:** 26 (0 errors, 2 warnings, 24 info)
...
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b598' has no load connected to phase terminal 'a'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b598' has no load connected to phase terminal 'b'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b598' has no load connected to phase terminal 'c'.
...
- **[I.PROV.DSS_DEFAULT_PF]** `load`  
  3 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[I.RED.MERGEABLE_LINES]** `line`  
  6 group(s) of series lines (15 lines total) can be merged — intermediate buses have no other connections.
