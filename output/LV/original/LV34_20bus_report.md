# BMOPF Network Summary: LV34_20bus
...
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b784' has no load connected to phase terminal 'a'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b784' has no load connected to phase terminal 'b'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b784' has no load connected to phase terminal 'c'.
...
| Buses without voltage bounds | 21 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 21 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b784' has no load connected to phase terminal 'a'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b784' has no load connected to phase terminal 'b'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b784' has no load connected to phase terminal 'c'.
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  21 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
