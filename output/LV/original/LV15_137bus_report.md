# BMOPF Network Summary: LV15_137bus

**Generated:** 2026-06-23 21:34:01  
**Findings:** 0 errors · 4 warnings · 24 info  
**Convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 48 grounding point(s)
...
> 🟡 **[W.CONN.DANGLING]** 27 bus(es) are degree-1 with no attached load, generator, or shunt.
...
|-----------|-----|-----|----|---|
| p_nom | 10000.0 | 10000.0 | 0.0 | 46 |
| q_nom | 5400.0 | 5400.0 | 0.0 | 46 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.0669 | 311.0 | 1.341 | 129 |
...
> 🟡 **[W.DIV.LOAD_SYMMETRIC]** 45 of 46 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
| | Value |
|--|-------|
| Total load P | 460.0 kW |
| Total load Q | 248.3 kvar |
...
> 🟡 **[W.OPS.IMPORT_DEPENDENT]** Network is heavily import-dependent: local generation capacity (0.0 MW) is less than 5% of total load (0.46 MW).
> 🟡 **[W.OPS.XFMR_OVERLOADED]** Transformer 'tx3394' is at 165.9% utilisation at nominal load — little OPF headroom.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b169' has no load connected to phase terminal 'a'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b169' has no load connected to phase terminal 'b'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b169' has no load connected to phase terminal 'c'.
...
| Buses without voltage bounds | 138 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 138 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
> 🔵 **[I.PRE.SINGLE_SOURCE]** Network has a single voltage source — single point of failure. Infeasibility of the source makes the entire network infeasible.

## 7. Provenance & Model Conventions

**Inferred convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 48 grounding point(s)

| Voltage level | Wires | Buses with neutral |
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 137 / 137 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 138 |
| Neutral branches | 136 |
| Grounding points | 48 |
| Neutral sections | 2 |
| Floating sections | 0 |
...
**OpenDSS default fingerprints:** 46 hit(s) — see findings
...
> 🔵 **[I.PROV.DSS_DEFAULT_PF]** 46 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
**Total findings:** 28 (0 errors, 4 warnings, 24 info)

### 🟡 Warnings

- **[W.CONN.DANGLING]** `bus`  
  27 bus(es) are degree-1 with no attached load, generator, or shunt.
- **[W.DIV.LOAD_SYMMETRIC]** `load`  
  45 of 46 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
- **[W.OPS.IMPORT_DEPENDENT]** `network`  
  Network is heavily import-dependent: local generation capacity (0.0 MW) is less than 5% of total load (0.46 MW).
...
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b169' has no load connected to phase terminal 'a'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b169' has no load connected to phase terminal 'b'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b169' has no load connected to phase terminal 'c'.
...
- **[I.PROV.DSS_DEFAULT_PF]** `load`  
  46 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  138 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
- **[I.RED.MERGEABLE_LINES]** `line`  
  6 group(s) of series lines (24 lines total) can be merged — intermediate buses have no other connections.
