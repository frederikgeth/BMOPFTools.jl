# BMOPF Network Summary: LV10_223bus

**Generated:** 2026-06-23 21:34:00  
**Findings:** 0 errors · 4 warnings · 26 info  
**Convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 96 grounding point(s)
...
> 🟡 **[W.CONN.DANGLING]** 45 bus(es) are degree-1 with no attached load, generator, or shunt.
...
|-----------|-----|-----|----|---|
| p_nom | 10000.0 | 10000.0 | 0.0 | 94 |
| q_nom | 5400.0 | 5400.0 | 0.0 | 94 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.0669 | 157.0 | 1.138 | 212 |
...
> 🟡 **[W.DIV.LOAD_SYMMETRIC]** 93 of 94 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
| | Value |
|--|-------|
| Total load P | 940.0 kW |
| Total load Q | 507.4 kvar |
...
> 🟡 **[W.OPS.IMPORT_DEPENDENT]** Network is heavily import-dependent: local generation capacity (0.0 MW) is less than 5% of total load (0.94 MW).
> 🟡 **[W.OPS.XFMR_OVERLOADED]** Transformer 'tx2187' is at 213.6% utilisation at nominal load — little OPF headroom.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b185' has no load connected to phase terminal 'a'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b185' has no load connected to phase terminal 'b'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b185' has no load connected to phase terminal 'c'.
...
| Buses without voltage bounds | 224 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 224 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
> 🔵 **[I.PRE.SINGLE_SOURCE]** Network has a single voltage source — single point of failure. Infeasibility of the source makes the entire network infeasible.

## 7. Provenance & Model Conventions

**Inferred convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 96 grounding point(s)

| Voltage level | Wires | Buses with neutral |
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 223 / 223 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 224 |
| Neutral branches | 222 |
| Grounding points | 96 |
| Neutral sections | 2 |
| Floating sections | 0 |
...
**OpenDSS default fingerprints:** 94 hit(s) — see findings
...
> 🔵 **[I.PROV.DSS_DEFAULT_PF]** 94 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[W.CONN.DANGLING]** `bus`  
  45 bus(es) are degree-1 with no attached load, generator, or shunt.
- **[W.DIV.LOAD_SYMMETRIC]** `load`  
  93 of 94 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
- **[W.OPS.IMPORT_DEPENDENT]** `network`  
  Network is heavily import-dependent: local generation capacity (0.0 MW) is less than 5% of total load (0.94 MW).
...
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b185' has no load connected to phase terminal 'a'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b185' has no load connected to phase terminal 'b'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b185' has no load connected to phase terminal 'c'.
...
- **[I.PROV.DSS_DEFAULT_PF]** `load`  
  94 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  224 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
...
- **[I.RED.MERGEABLE_LINES]** `line`  
  10 group(s) of series lines (24 lines total) can be merged — intermediate buses have no other connections.
