...
> 🟡 **[W.CONN.DANGLING]** 40 bus(es) are degree-1 with no attached load, generator, or shunt.
...
|-----------|-----|-----|----|---|
| p_nom | 10000.0 | 10000.0 | 0.0 | 112 |
| q_nom | 5400.0 | 5400.0 | 0.0 | 112 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.0748 | 744.0 | 2.4 | 223 |
...
> 🟡 **[W.DIV.LOAD_SYMMETRIC]** 111 of 112 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
| | Value |
|--|-------|
| Total load P | 1.12 MW |
| Total load Q | 604.5 kvar |
...
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b2995' has no load connected to phase terminal 'a'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b2995' has no load connected to phase terminal 'b'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b2995' has no load connected to phase terminal 'c'.
...
| Buses without voltage bounds | 233 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 233 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
> 🔵 **[I.PRE.SINGLE_SOURCE]** Network has a single voltage source — single point of failure. Infeasibility of the source makes the entire network infeasible.

## 7. Provenance & Model Conventions

**Inferred convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 114 grounding point(s)

| Voltage level | Wires | Buses with neutral |
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 232 / 232 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 233 |
| Neutral branches | 231 |
| Grounding points | 114 |
| Neutral sections | 2 |
| Floating sections | 0 |
...
**OpenDSS default fingerprints:** 112 hit(s) — see findings
...
> 🔵 **[I.PROV.DSS_DEFAULT_PF]** 112 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[W.CONN.DANGLING]** `bus`  
  40 bus(es) are degree-1 with no attached load, generator, or shunt.
- **[W.DIV.LOAD_SYMMETRIC]** `load`  
  111 of 112 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
- **[W.OPS.IMPORT_DEPENDENT]** `network`  
  Network is heavily import-dependent: local generation capacity (0.0 MW) is less than 5% of total load (1.12 MW).
...
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b2995' has no load connected to phase terminal 'a'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b2995' has no load connected to phase terminal 'b'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b2995' has no load connected to phase terminal 'c'.
...
- **[I.PROV.DSS_DEFAULT_PF]** `load`  
  112 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  233 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
