# BMOPF Network Summary: LV2_43bus

**Generated:** 2026-06-23 21:34:01  
**Findings:** 0 errors · 3 warnings · 22 info  
**Convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 9 grounding point(s)
...
|-----------|-----|-----|----|---|
| p_nom | 10000.0 | 10000.0 | 0.0 | 7 |
| q_nom | 5400.0 | 5400.0 | 0.0 | 7 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.2 | 186.0 | 1.723 | 40 |
...
> 🟡 **[W.DIV.LOAD_SYMMETRIC]** 6 of 7 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
| | Value |
|--|-------|
| Total load P | 70.0 kW |
| Total load Q | 37.8 kvar |
...
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b3198' has no load connected to phase terminal 'a'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b3198' has no load connected to phase terminal 'b'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b3198' has no load connected to phase terminal 'c'.
...
**Inferred convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 9 grounding point(s)

| Voltage level | Wires | Buses with neutral |
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 43 / 43 |
...
**OpenDSS default fingerprints:** 7 hit(s) — see findings
...
> 🔵 **[I.PROV.DSS_DEFAULT_PF]** 7 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[W.DIV.LOAD_SYMMETRIC]** `load`  
  6 of 7 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b3198' has no load connected to phase terminal 'a'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b3198' has no load connected to phase terminal 'b'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b3198' has no load connected to phase terminal 'c'.
...
- **[I.PROV.DSS_DEFAULT_PF]** `load`  
  7 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[I.RED.MERGEABLE_LINES]** `line`  
  12 group(s) of series lines (29 lines total) can be merged — intermediate buses have no other connections.
