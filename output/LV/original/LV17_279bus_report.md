...
> 🟡 **[W.CONN.DANGLING]** 46 bus(es) are degree-1 with no attached load, generator, or shunt.
...
|-----------|-----|-----|----|---|
| p_nom | 10000.0 | 10000.0 | 0.0 | 141 |
| q_nom | 5400.0 | 5400.0 | 0.0 | 141 |

### line ⚠

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.0748 | 149.0 | 0.994 | 269 |
...
| | Value |
|--|-------|
| Total load P | 1.41 MW |
| Total load Q | 761.0 kvar |
...
| Buses without voltage bounds | 280 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 280 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
> 🔵 **[I.PRE.SINGLE_SOURCE]** Network has a single voltage source — single point of failure. Infeasibility of the source makes the entire network infeasible.

## 7. Provenance & Model Conventions

**Inferred convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 143 grounding point(s)

| Voltage level | Wires | Buses with neutral |
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 279 / 279 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 280 |
| Neutral branches | 278 |
...
**OpenDSS default fingerprints:** 141 hit(s) — see findings
...
> 🔵 **[I.PROV.DSS_DEFAULT_PF]** 141 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[W.CONN.DANGLING]** `bus`  
  46 bus(es) are degree-1 with no attached load, generator, or shunt.
...
- **[I.DIV.LOAD_UNIFORM_MODEL]** `load`  
  All 141 loads use the constant_power model — no load exercises voltage dependence (ZIP/exponential); the case does not test voltage-dependent load behaviour.
...
- **[I.PROV.DSS_DEFAULT_PF]** `load`  
  141 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[I.RED.UNUSED_LINECODES]** `linecode`  
  15 linecode(s) defined but not referenced by any line.
