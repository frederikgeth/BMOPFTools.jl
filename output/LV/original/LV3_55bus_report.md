...
**Findings:** 0 errors · 3 warnings · 25 info  
...
|-----------|-----|-----|----|---|
| p_nom | 10000.0 | 10000.0 | 0.0 | 12 |
| q_nom | 5400.0 | 5400.0 | 0.0 | 12 |

### line

| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| length | 0.0669 | 93.4 | 1.086 | 46 |
...
> 🟡 **[W.DIV.LOAD_SYMMETRIC]** 11 of 12 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
> 🔵 **[I.DIV.LOAD_UNIFORM_MODEL]** All 12 loads use the constant_power model — no load exercises voltage dependence (ZIP/exponential); the case does not test voltage-dependent load behaviour.
> 🔵 **[I.DIV.LOAD_UNIFORM_CONFIG]** All 12 loads share the 'SINGLE_PHASE' configuration — no connection diversity.
...
| | Value |
|--|-------|
| Total load P | 120.0 kW |
| Total load Q | 64.8 kvar |
...
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b804' has no load connected to phase terminal 'a'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b804' has no load connected to phase terminal 'b'.
> 🔵 **[I.OPS.UNLOADED_PHASE]** Galvanic zone anchored at bus 'b804' has no load connected to phase terminal 'c'.
...
| Buses without voltage bounds | 56 |
| Single point of failure | true |
| TPIA status | not_run |

> 🔵 **[I.PRE.NO_VOLT_BOUNDS]** 56 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
> 🔵 **[I.PRE.SINGLE_SOURCE]** Network has a single voltage source — single point of failure. Infeasibility of the source makes the entire network infeasible.

## 7. Provenance & Model Conventions

**Inferred convention:** MV_6.4kV: 4-wire; LV_250V: 4-wire; 14 grounding point(s)

| Voltage level | Wires | Buses with neutral |
|---------------|-------|-------------------:|
| MV_6.4kV | 4-wire | 1 / 1 |
| LV_250V | 4-wire | 55 / 55 |
...
**OpenDSS default fingerprints:** 12 hit(s) — see findings
...
> 🔵 **[I.PROV.DSS_DEFAULT_PF]** 12 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
**Total findings:** 28 (0 errors, 3 warnings, 25 info)
...
- **[W.DIV.LOAD_SYMMETRIC]** `load`  
  11 of 12 loads share identical (p_nom, q_nom) — possible copy-paste symmetry.
...
- **[I.DIV.LOAD_UNIFORM_MODEL]** `load`  
  All 12 loads use the constant_power model — no load exercises voltage dependence (ZIP/exponential); the case does not test voltage-dependent load behaviour.
- **[I.DIV.LOAD_UNIFORM_CONFIG]** `load`  
  All 12 loads share the 'SINGLE_PHASE' configuration — no connection diversity.
...
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b804' has no load connected to phase terminal 'a'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b804' has no load connected to phase terminal 'b'.
- **[I.OPS.UNLOADED_PHASE]** `network`  
  Galvanic zone anchored at bus 'b804' has no load connected to phase terminal 'c'.
...
- **[I.PROV.DSS_DEFAULT_PF]** `load`  
  12 load(s) have power factor exactly 0.88 — the OpenDSS default; reactive demand was likely never specified.
...
- **[I.PRE.NO_VOLT_BOUNDS]** `bus`  
  56 bus(es) have no voltage bounds — voltage will be unconstrained at these buses.
