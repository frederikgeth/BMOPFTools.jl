...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 18.432 kW |
| Total load | 8.241 kW |
| Total network losses (P) | 10.191 kW |
| Total network losses (Q) | 3.713 kW var |
| Loss fraction | 123.7% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 6.45 V (bus `89`) |
...
| ✅ | `91` | 238.8 | 240.0 | 1.038 | 1.044 | 0.5 % | 4.28 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_8`  
  IBR 'pv_8' phase 'c': pg=5.218 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_13`  
  IBR 'pv_13' phase 'c': pg=5.211 kW is within 1 % of its P bound.
