...
| Total network losses (Q) | 542.15 W var |
| Loss fraction | 15.3% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 3.011 V (bus `83`) |
...
|:--:|------|-------:|------:|------------:|------------:|--------------:|------------------:|
| ✅ | `100` | 230.0 V | 30 | 1.0 (`sourcebus`) | 1.027 (`83`) | 1.6 % (`83`) | 3.01 V (`83`) |
...
|:--:|-----|-----------:|-----------:|------------:|------------:|----------:|--------:|
| ✅ | `83` | 232.4 | 236.2 | 1.011 | 1.027 | 1.6 % | 3.01 V |
| ✅ | `107` | 232.4 | 236.2 | 1.011 | 1.027 | 1.6 % | 3.01 V |
| ✅ | `104` | 232.4 | 236.1 | 1.011 | 1.027 | 1.6 % | 2.93 V |
| ✅ | `89` | 232.4 | 236.1 | 1.011 | 1.027 | 1.6 % | 2.93 V |
| ✅ | `92` | 232.4 | 236.0 | 1.011 | 1.026 | 1.6 % | 2.84 V |
| ✅ | `95` | 232.4 | 236.0 | 1.011 | 1.026 | 1.6 % | 2.82 V |
| ✅ | `101` | 232.4 | 236.0 | 1.011 | 1.026 | 1.6 % | 2.81 V |
| ✅ | `80` | 232.4 | 235.6 | 1.011 | 1.024 | 1.4 % | 2.37 V |
| ✅ | `86` | 232.4 | 235.6 | 1.011 | 1.024 | 1.4 % | 2.37 V |
| ✅ | `98` | 232.4 | 235.5 | 1.011 | 1.024 | 1.3 % | 2.26 V |
| ✅ | `102` | 232.5 | 235.4 | 1.011 | 1.024 | 1.3 % | 2.22 V |
| ✅ | `99` | 232.5 | 235.4 | 1.011 | 1.023 | 1.3 % | 2.2 V |
| ✅ | `105` | 232.5 | 235.4 | 1.011 | 1.023 | 1.3 % | 2.2 V |
| ✅ | `90` | 232.5 | 235.4 | 1.011 | 1.023 | 1.3 % | 2.19 V |
| ✅ | `81` | 232.5 | 235.3 | 1.011 | 1.023 | 1.2 % | 2.12 V |
| ✅ | `87` | 232.5 | 235.2 | 1.011 | 1.023 | 1.2 % | 2.05 V |
| ✅ | `96` | 232.5 | 235.2 | 1.011 | 1.022 | 1.2 % | 2.03 V |
| ✅ | `93` | 232.5 | 234.9 | 1.011 | 1.021 | 1.0 % | 1.97 V |
| ✅ | `84` | 232.5 | 234.8 | 1.011 | 1.021 | 1.0 % | 1.88 V |
| ✅ | `97` | 233.7 | 234.5 | 1.016 | 1.019 | 0.4 % | 1.0 V |
| ✅ | `100` | 233.7 | 234.5 | 1.016 | 1.019 | 0.4 % | 0.96 V |
| ✅ | `88` | 233.7 | 234.5 | 1.016 | 1.019 | 0.4 % | 0.88 V |
| ✅ | `91` | 233.7 | 234.5 | 1.016 | 1.019 | 0.4 % | 0.86 V |
| ✅ | `106` | 233.7 | 234.5 | 1.016 | 1.019 | 0.4 % | 0.82 V |
| ✅ | `94` | 233.7 | 234.5 | 1.016 | 1.019 | 0.4 % | 0.69 V |
| ✅ | `103` | 233.6 | 234.5 | 1.016 | 1.019 | 0.4 % | 0.53 V |
| ✅ | `82` | 233.4 | 234.5 | 1.015 | 1.019 | 0.5 % | 0.44 V |
| ✅ | `85` | 233.0 | 234.5 | 1.013 | 1.019 | 0.6 % | 0.65 V |
| ✅ | `79` | 232.5 | 234.5 | 1.011 | 1.019 | 0.9 % | 1.33 V |
...
- INFO `I.SOL.NEUTRAL_SHIFT`  
  Maximum neutral terminal voltage: 3.01 V at bus '83' — reflects the neutral shift under unbalanced loading.
