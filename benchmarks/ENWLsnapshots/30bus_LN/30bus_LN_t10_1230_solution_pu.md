...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 15.862 kW |
| Total load | 5.868 kW |
| Total network losses (P) | 9.993 kW |
| Total network losses (Q) | 3.619 kW var |
| Loss fraction | 170.3% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 6.709 V (bus `95`) |
...
| ✅ | `107` | 235.9 | 243.4 | 1.026 | 1.058 | 3.2 % | 6.69 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_7`  
  IBR 'pv_7' phase 'b': pg=5.177 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_6`  
  IBR 'pv_6' phase 'b': pg=5.178 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_24`  
  IBR 'pv_24' phase 'a': pg=5.006 kW is within 1 % of its P bound.
