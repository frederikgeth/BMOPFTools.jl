...
**Objective:** -116420.7736  
**Solve time:** 0.059 s  
**Findings:** 9 errors · 23 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 19.095 kW |
| Total load | 9.638 kW |
| Total network losses (P) | 9.457 kW |
| Total network losses (Q) | 3.448 kW var |
| Loss fraction | 98.1% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 6.254 V (bus `95`) |
...
| ✅ | `89` | 235.9 | 242.8 | 1.026 | 1.056 | 3.0 % | 5.73 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_21`  
  IBR 'pv_21' phase 'c': pg=5.178 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_1`  
  IBR 'pv_1' phase 'b': pg=5.181 kW is within 1 % of its P bound.
