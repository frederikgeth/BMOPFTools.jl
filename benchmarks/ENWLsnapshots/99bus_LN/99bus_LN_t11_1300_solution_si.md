...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 36.011 kW |
| Total load | 12.38 kW |
| Total network losses (P) | 23.631 kW |
| Total network losses (Q) | 7.034 kW var |
| Loss fraction | 190.9% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 15.281 V (bus `896`) |
...
| ✅ | `654` | 239.4 | 249.4 | 1.041 | 1.084 | 4.3 % | 14.45 V |
...
| ✅ | `116` | 236.9 | 244.5 | 1.03 | 1.063 | 3.3 % | 7.98 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_41`  
  IBR 'pv_41' phase 'a': pg=4.521 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_45`  
  IBR 'pv_45' phase 'a': pg=4.229 kW is within 1 % of its P bound.
