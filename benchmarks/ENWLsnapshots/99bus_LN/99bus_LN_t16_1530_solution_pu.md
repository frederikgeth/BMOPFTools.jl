...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 41.761 kW |
| Total load | 19.861 kW |
| Total network losses (P) | 21.9 kW |
| Total network losses (Q) | 6.536 kW var |
| Loss fraction | 110.3% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 15.028 V (bus `896`) |
...
| ✅ | `895` | 239.9 | 248.8 | 1.043 | 1.082 | 3.9 % | 13.84 V |
| ✅ | `654` | 239.2 | 248.8 | 1.04 | 1.082 | 4.2 % | 14.21 V |
| ✅ | `644` | 239.2 | 248.7 | 1.04 | 1.081 | 4.1 % | 14.19 V |
| ✅ | `904` | 239.9 | 248.7 | 1.043 | 1.081 | 3.8 % | 13.75 V |
| ✅ | `635` | 239.2 | 248.7 | 1.04 | 1.081 | 4.1 % | 14.11 V |
...
| ✅ | `303` | 236.3 | 247.1 | 1.027 | 1.075 | 4.7 % | 12.32 V |
...
| ✅ | `128` | 236.7 | 243.9 | 1.029 | 1.061 | 3.2 % | 7.7 V |
...
| ✅ | `179` | 236.8 | 243.4 | 1.029 | 1.058 | 2.9 % | 6.18 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_44`  
  IBR 'pv_44' phase 'a': pg=4.557 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_12`  
  IBR 'pv_12' phase 'b': pg=5.15 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_15`  
  IBR 'pv_15' phase 'a': pg=5.109 kW is within 1 % of its P bound.
...
- INFO `I.SOL.LOSS_FRACTION`  
  Line losses are 110.3 % of total load — unusually high; verify impedance scaling and operating point.
