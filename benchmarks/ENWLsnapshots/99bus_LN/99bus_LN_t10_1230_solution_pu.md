...
**Objective:** -190661.8056  
**Solve time:** 0.064 s  
**Findings:** 10 errors · 39 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 34.793 kW |
| Total load | 11.642 kW |
| Total network losses (P) | 23.151 kW |
| Total network losses (Q) | 6.857 kW var |
| Loss fraction | 198.9% |
...
| ✅ | `660` | 239.1 | 249.5 | 1.04 | 1.085 | 4.5 % | 14.81 V |
...
| ✅ | `472` | 236.7 | 247.6 | 1.029 | 1.077 | 4.7 % | 3.18 V |
...
| ✅ | `428` | 238.9 | 245.0 | 1.039 | 1.065 | 2.7 % | 9.35 V |
...
| ✅ | `131` | 236.5 | 245.0 | 1.028 | 1.065 | 3.7 % | 9.15 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_36`  
  IBR 'pv_36' phase 'a': pg=4.751 kW is within 1 % of its P bound.
...
- INFO `I.SOL.LOSS_FRACTION`  
  Line losses are 198.9 % of total load — unusually high; verify impedance scaling and operating point.
