...
**Objective:** -181860.1767  
**Solve time:** 0.053 s  
**Findings:** 5 errors · 43 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 33.125 kW |
| Total load | 11.521 kW |
| Total network losses (P) | 21.605 kW |
...
| ✅ | `677` | 238.5 | 249.0 | 1.037 | 1.083 | 4.5 % | 15.08 V |
...
| ✅ | `635` | 238.5 | 248.7 | 1.037 | 1.081 | 4.4 % | 14.62 V |
...
| ✅ | `673` | 239.3 | 248.2 | 1.041 | 1.079 | 3.8 % | 13.93 V |
...
| ✅ | `659` | 239.3 | 248.1 | 1.04 | 1.079 | 3.8 % | 13.83 V |
...
| ✅ | `416` | 238.1 | 244.6 | 1.035 | 1.064 | 2.8 % | 9.45 V |
...
| ✅ | `318` | 237.5 | 244.6 | 1.033 | 1.063 | 3.1 % | 9.17 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_32`  
  IBR 'pv_32' phase 'a': pg=4.037 kW is within 1 % of its P bound.
