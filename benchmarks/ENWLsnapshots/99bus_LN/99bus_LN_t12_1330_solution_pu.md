...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 36.924 kW |
| Total load | 13.109 kW |
| Total network losses (P) | 23.815 kW |
| Total network losses (Q) | 7.092 kW var |
| Loss fraction | 181.7% |
...
|:--:|-----|-----------:|-----------:|------------:|------------:|----------:|--------:|
| ✅ | `896` | 239.5 | 250.0 | 1.041 | 1.087 | 4.6 % | 15.19 V |
...
| ✅ | `635` | 239.5 | 249.3 | 1.041 | 1.084 | 4.2 % | 14.25 V |
| ✅ | `775` | 240.3 | 249.2 | 1.045 | 1.083 | 3.8 % | 13.86 V |
| ✅ | `849` | 240.3 | 249.2 | 1.045 | 1.083 | 3.9 % | 13.7 V |
| ✅ | `894` | 240.3 | 249.2 | 1.045 | 1.083 | 3.9 % | 12.67 V |
...
| ✅ | `608` | 239.5 | 248.7 | 1.041 | 1.081 | 4.0 % | 13.49 V |
| ✅ | `659` | 240.3 | 248.7 | 1.045 | 1.081 | 3.6 % | 13.43 V |
| ✅ | `607` | 239.5 | 248.6 | 1.042 | 1.081 | 3.9 % | 13.43 V |
...
| ✅ | `545` | 239.6 | 248.1 | 1.042 | 1.078 | 3.7 % | 12.78 V |
...
| ✅ | `166` | 236.8 | 245.7 | 1.029 | 1.068 | 3.9 % | 9.66 V |
...
| ✅ | `144` | 236.8 | 245.1 | 1.03 | 1.066 | 3.6 % | 8.98 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_46`  
  IBR 'pv_46' phase 'b': pg=5.2 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_42`  
  IBR 'pv_42' phase 'c': pg=5.133 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_28`  
  IBR 'pv_28' phase 'b': pg=5.229 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_1`  
  IBR 'pv_1' phase 'a': pg=4.618 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_16`  
  IBR 'pv_16' phase 'b': pg=5.247 kW is within 1 % of its P bound.
...
- INFO `I.SOL.LOSS_FRACTION`  
  Line losses are 181.7 % of total load — unusually high; verify impedance scaling and operating point.
