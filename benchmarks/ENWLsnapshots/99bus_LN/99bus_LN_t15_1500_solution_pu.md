...
**Objective:** -191107.4168  
**Solve time:** 0.065 s  
**Findings:** 24 errors · 32 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 40.168 kW |
| Total load | 16.896 kW |
| Total network losses (P) | 23.272 kW |
| Total network losses (Q) | 6.926 kW var |
| Loss fraction | 137.7% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 15.181 V (bus `896`) |
...
| ✅ | `949` | 240.1 | 249.5 | 1.044 | 1.085 | 4.1 % | 14.22 V |
...
| ✅ | `849` | 240.1 | 248.9 | 1.044 | 1.082 | 3.8 % | 13.72 V |
| ✅ | `894` | 240.1 | 248.9 | 1.044 | 1.082 | 3.8 % | 12.74 V |
| ✅ | `808` | 240.9 | 248.5 | 1.047 | 1.081 | 3.3 % | 13.83 V |
| ✅ | `693` | 240.2 | 248.5 | 1.044 | 1.081 | 3.6 % | 13.54 V |
| ✅ | `673` | 240.2 | 248.5 | 1.044 | 1.081 | 3.6 % | 13.53 V |
...
| ✅ | `607` | 239.4 | 248.4 | 1.041 | 1.08 | 3.9 % | 13.43 V |
...
| ✅ | `568` | 240.0 | 248.3 | 1.044 | 1.079 | 3.6 % | 13.27 V |
...
| ✅ | `472` | 236.9 | 247.8 | 1.03 | 1.077 | 4.7 % | 3.3 V |
...
| ✅ | `272` | 236.4 | 247.1 | 1.028 | 1.075 | 4.7 % | 12.17 V |
...
| ✅ | `145` | 236.7 | 245.1 | 1.029 | 1.065 | 3.7 % | 9.18 V |
...
| ✅ | `391` | 239.0 | 244.9 | 1.039 | 1.065 | 2.6 % | 9.06 V |
| ✅ | `392` | 238.9 | 244.9 | 1.039 | 1.065 | 2.6 % | 9.06 V |
| ✅ | `380` | 238.9 | 244.9 | 1.039 | 1.065 | 2.6 % | 9.04 V |
| ✅ | `131` | 236.7 | 244.9 | 1.029 | 1.065 | 3.6 % | 8.9 V |
| ✅ | `366` | 238.8 | 244.9 | 1.038 | 1.065 | 2.6 % | 9.0 V |
| ✅ | `355` | 238.8 | 244.9 | 1.038 | 1.065 | 2.6 % | 8.98 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_14`  
  IBR 'pv_14' phase 'a': pg=4.428 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_44`  
  IBR 'pv_44' phase 'a': pg=4.269 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_27`  
  IBR 'pv_27' phase 'b': pg=5.142 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_32`  
  IBR 'pv_32' phase 'a': pg=4.058 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_16`  
  IBR 'pv_16' phase 'b': pg=5.249 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_20`  
  IBR 'pv_20' phase 'a': pg=4.666 kW is within 1 % of its P bound.
