...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 37.715 kW |
| Total load | 13.973 kW |
| Total network losses (P) | 23.742 kW |
| Total network losses (Q) | 7.062 kW var |
| Loss fraction | 169.9% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 15.284 V (bus `896`) |
...
|:--:|------|-------:|------:|------------:|------------:|--------------:|------------------:|
| ✅ | `104` | 230.0 V | 99 | 1.0 (`sourcebus`) | 1.087 (`896`) | 4.9 % (`498`) | 15.28 V (`896`) |
...
|:--:|-----|-----------:|-----------:|------------:|------------:|----------:|--------:|
| ✅ | `896` | 239.4 | 249.9 | 1.041 | 1.087 | 4.6 % | 15.28 V |
...
| ✅ | `775` | 240.3 | 249.2 | 1.045 | 1.083 | 3.9 % | 13.96 V |
...
| ✅ | `439` | 236.9 | 247.8 | 1.03 | 1.078 | 4.7 % | 3.33 V |
...
| ✅ | `521` | 236.9 | 246.9 | 1.03 | 1.073 | 4.3 % | 3.19 V |
...
| ✅ | `166` | 236.7 | 245.7 | 1.029 | 1.068 | 3.9 % | 9.76 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_22`  
  IBR 'pv_22' phase 'c': pg=4.8 kW is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_14`  
  IBR 'pv_14' phase 'a': pg=4.303 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_41`  
  IBR 'pv_41' phase 'a': pg=4.534 kW is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_32`  
  IBR 'pv_32' phase 'a': pg=3.916 kW is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_7`  
  IBR 'pv_7' phase 'a': pg=4.463 kW is within 1 % of its P bound.
