...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 43.121 kW |
| Total load | 23.59 kW |
| Total network losses (P) | 19.531 kW |
| Total network losses (Q) | 5.788 kW var |
| Loss fraction | 82.8% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 14.656 V (bus `896`) |
...
| ✅ | `660` | 238.3 | 247.6 | 1.036 | 1.077 | 4.1 % | 14.09 V |
...
| ✅ | `808` | 239.9 | 247.1 | 1.043 | 1.074 | 3.1 % | 13.48 V |
...
| ✅ | `659` | 239.1 | 247.0 | 1.039 | 1.074 | 3.4 % | 13.07 V |
| ✅ | `617` | 238.3 | 247.0 | 1.036 | 1.074 | 3.8 % | 13.07 V |
| ✅ | `618` | 238.3 | 247.0 | 1.036 | 1.074 | 3.8 % | 13.07 V |
| ✅ | `608` | 238.3 | 247.0 | 1.036 | 1.074 | 3.7 % | 13.04 V |
...
| ✅ | `263` | 235.7 | 245.3 | 1.025 | 1.067 | 4.2 % | 10.92 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_41`  
  IBR 'pv_41' phase 'a': pg=4.695 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_21`  
  IBR 'pv_21' phase 'c': pg=4.892 kW is within 1 % of its P bound.
