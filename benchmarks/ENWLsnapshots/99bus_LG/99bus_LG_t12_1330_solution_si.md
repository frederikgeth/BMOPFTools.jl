...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 37.502 kW |
| Total load | 13.109 kW |
| Total network losses (P) | 24.393 kW |
| Total network losses (Q) | 7.053 kW var |
| Loss fraction | 186.1% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 18.326 V (bus `896`) |
...
| ✅ | `391` | 240.9 | 246.9 | 1.047 | 1.073 | 2.6 % | 11.48 V |
...
| ✅ | `318` | 240.2 | 246.8 | 1.044 | 1.073 | 2.9 % | 11.33 V |
...
| ✅ | `256` | 238.4 | 245.7 | 1.037 | 1.068 | 3.2 % | 7.95 V |
...
| ✅ | `188` | 238.4 | 245.5 | 1.037 | 1.067 | 3.1 % | 8.82 V |
| ✅ | `179` | 238.4 | 245.5 | 1.037 | 1.067 | 3.1 % | 9.32 V |
| ✅ | `162` | 238.4 | 245.5 | 1.037 | 1.067 | 3.1 % | 9.41 V |
| ✅ | `187` | 238.4 | 245.5 | 1.037 | 1.067 | 3.1 % | 9.62 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_22`  
  IBR 'pv_22' phase 'c': pg=5.22 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_5`  
  IBR 'pv_5' phase 'c': pg=5.249 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_16`  
  IBR 'pv_16' phase 'b': pg=5.198 kW is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_9`  
  IBR 'pv_9' phase 'c': pg=5.247 kW is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_10`  
  IBR 'pv_10' phase 'c': pg=4.787 kW is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_8`  
  IBR 'pv_8' phase 'b': pg=5.238 kW is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_40`  
  IBR 'pv_40' phase 'c': pg=4.895 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_17`  
  IBR 'pv_17' phase 'c': pg=5.211 kW is within 1 % of its P bound.
