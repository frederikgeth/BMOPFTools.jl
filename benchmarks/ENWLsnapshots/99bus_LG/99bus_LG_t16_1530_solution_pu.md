...
**Objective:** -188680.8944  
**Solve time:** 0.056 s  
**Findings:** 10 errors · 42 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 41.152 kW |
| Total load | 19.861 kW |
| Total network losses (P) | 21.291 kW |
| Total network losses (Q) | 6.162 kW var |
| Loss fraction | 107.2% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 17.131 V (bus `896`) |
...
| ✅ | `904` | 241.0 | 250.1 | 1.048 | 1.087 | 4.0 % | 15.99 V |
...
| ✅ | `627` | 240.6 | 249.6 | 1.046 | 1.085 | 3.9 % | 15.55 V |
| ✅ | `665` | 240.8 | 249.6 | 1.047 | 1.085 | 3.8 % | 15.57 V |
| ✅ | `617` | 240.6 | 249.5 | 1.046 | 1.085 | 3.9 % | 15.5 V |
| ✅ | `779` | 240.8 | 249.5 | 1.047 | 1.085 | 3.8 % | 15.83 V |
...
| ✅ | `282` | 237.7 | 248.5 | 1.033 | 1.08 | 4.7 % | 14.05 V |
| ✅ | `272` | 237.7 | 248.4 | 1.033 | 1.08 | 4.7 % | 13.95 V |
| ✅ | `321` | 237.7 | 248.1 | 1.034 | 1.079 | 4.5 % | 13.64 V |
| ✅ | `264` | 237.7 | 248.1 | 1.034 | 1.079 | 4.5 % | 13.55 V |
...
| ✅ | `380` | 240.5 | 245.9 | 1.046 | 1.069 | 2.3 % | 10.82 V |
| ✅ | `392` | 240.5 | 245.9 | 1.046 | 1.069 | 2.3 % | 10.81 V |
| ✅ | `366` | 240.4 | 245.9 | 1.045 | 1.069 | 2.4 % | 10.78 V |
| ✅ | `131` | 237.9 | 245.9 | 1.035 | 1.069 | 3.4 % | 10.89 V |
...
| ✅ | `384` | 239.9 | 245.8 | 1.043 | 1.069 | 2.6 % | 10.65 V |
...
| ✅ | `354` | 238.1 | 245.5 | 1.035 | 1.067 | 3.2 % | 6.87 V |
...
| ✅ | `108` | 238.1 | 244.7 | 1.035 | 1.064 | 2.9 % | 9.46 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_12`  
  IBR 'pv_12' phase 'b': pg=5.139 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_47`  
  IBR 'pv_47' phase 'c': pg=5.25 kW is within 1 % of its P bound.
