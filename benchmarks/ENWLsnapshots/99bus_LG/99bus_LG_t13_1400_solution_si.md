...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 38.333 kW |
| Total load | 13.973 kW |
| Total network losses (P) | 24.36 kW |
| Total network losses (Q) | 7.022 kW var |
| Loss fraction | 174.3% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 18.608 V (bus `896`) |
...
|:--:|-----|-----------:|-----------:|------------:|------------:|----------:|--------:|
| ✅ | `896` | 241.3 | 252.3 | 1.049 | 1.097 | 4.8 % | 18.61 V |
| ✅ | `949` | 241.8 | 251.9 | 1.051 | 1.095 | 4.4 % | 17.69 V |
| ✅ | `677` | 241.4 | 251.8 | 1.049 | 1.095 | 4.5 % | 18.03 V |
| ✅ | `660` | 241.4 | 251.8 | 1.049 | 1.095 | 4.5 % | 17.95 V |
| ✅ | `661` | 241.4 | 251.7 | 1.049 | 1.094 | 4.5 % | 17.82 V |
...
| ✅ | `498` | 238.2 | 247.4 | 1.036 | 1.076 | 4.0 % | 8.46 V |
| ✅ | `491` | 238.2 | 247.3 | 1.036 | 1.075 | 4.0 % | 8.44 V |
| ✅ | `151` | 238.0 | 247.3 | 1.035 | 1.075 | 4.0 % | 12.45 V |
| ✅ | `473` | 238.2 | 247.2 | 1.036 | 1.075 | 3.9 % | 8.42 V |
| ✅ | `145` | 238.0 | 247.2 | 1.035 | 1.075 | 4.0 % | 12.35 V |
| ✅ | `472` | 238.2 | 247.1 | 1.036 | 1.075 | 3.9 % | 8.4 V |
| ✅ | `138` | 238.0 | 247.1 | 1.035 | 1.074 | 3.9 % | 12.21 V |
| ✅ | `439` | 238.2 | 247.1 | 1.036 | 1.074 | 3.8 % | 8.38 V |
| ✅ | `144` | 238.0 | 247.0 | 1.035 | 1.074 | 3.9 % | 12.15 V |
| ✅ | `536` | 238.2 | 247.0 | 1.036 | 1.074 | 3.8 % | 8.37 V |
| ✅ | `131` | 238.0 | 247.0 | 1.035 | 1.074 | 3.9 % | 12.07 V |
...
| ✅ | `441` | 240.2 | 246.9 | 1.044 | 1.074 | 2.9 % | 11.68 V |
| ✅ | `348` | 240.4 | 246.9 | 1.045 | 1.073 | 2.8 % | 11.8 V |
| ✅ | `327` | 240.1 | 246.9 | 1.044 | 1.073 | 3.0 % | 11.65 V |
| ✅ | `384` | 240.0 | 246.9 | 1.043 | 1.073 | 3.0 % | 11.64 V |
| ✅ | `318` | 239.9 | 246.9 | 1.043 | 1.073 | 3.0 % | 11.63 V |
| ✅ | `427` | 238.2 | 246.9 | 1.036 | 1.073 | 3.8 % | 8.35 V |
| ✅ | `300` | 239.8 | 246.9 | 1.043 | 1.073 | 3.1 % | 11.6 V |
| ✅ | `479` | 238.2 | 246.7 | 1.036 | 1.073 | 3.7 % | 8.31 V |
| ✅ | `377` | 238.2 | 246.6 | 1.036 | 1.072 | 3.6 % | 8.3 V |
...
| ✅ | `219` | 238.2 | 245.6 | 1.036 | 1.068 | 3.2 % | 8.56 V |
| ✅ | `208` | 238.2 | 245.6 | 1.036 | 1.068 | 3.2 % | 8.6 V |
| ✅ | `201` | 238.2 | 245.6 | 1.036 | 1.068 | 3.2 % | 9.09 V |
| ✅ | `188` | 238.2 | 245.6 | 1.036 | 1.068 | 3.2 % | 9.15 V |
| ✅ | `179` | 238.2 | 245.6 | 1.036 | 1.068 | 3.2 % | 9.63 V |
| ✅ | `162` | 238.2 | 245.6 | 1.036 | 1.068 | 3.2 % | 9.72 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_34`  
  IBR 'pv_34' phase 'b': pg=5.243 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_21`  
  IBR 'pv_21' phase 'c': pg=5.218 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_16`  
  IBR 'pv_16' phase 'b': pg=5.201 kW is within 1 % of its P bound.
