...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 34.519 kW |
| Total load | 11.642 kW |
| Total network losses (P) | 22.877 kW |
| Total network losses (Q) | 6.589 kW var |
| Loss fraction | 196.5% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 18.15 V (bus `896`) |
...
| ✅ | `677` | 240.8 | 251.5 | 1.047 | 1.094 | 4.7 % | 17.57 V |
| ✅ | `660` | 240.8 | 251.5 | 1.047 | 1.093 | 4.6 % | 17.49 V |
...
| ✅ | `693` | 241.5 | 250.6 | 1.05 | 1.089 | 4.0 % | 16.3 V |
| ✅ | `673` | 241.5 | 250.6 | 1.05 | 1.089 | 4.0 % | 16.29 V |
| ✅ | `617` | 240.9 | 250.6 | 1.047 | 1.089 | 4.2 % | 16.32 V |
| ✅ | `618` | 240.9 | 250.5 | 1.047 | 1.089 | 4.2 % | 16.31 V |
| ✅ | `665` | 241.5 | 250.5 | 1.05 | 1.089 | 3.9 % | 16.23 V |
| ✅ | `608` | 240.9 | 250.5 | 1.047 | 1.089 | 4.2 % | 16.28 V |
...
| ✅ | `545` | 240.9 | 249.9 | 1.047 | 1.086 | 3.9 % | 15.5 V |
...
| ✅ | `530` | 239.9 | 247.8 | 1.043 | 1.077 | 3.4 % | 12.85 V |
...
| ✅ | `256` | 237.9 | 245.3 | 1.034 | 1.066 | 3.2 % | 8.19 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_37`  
  IBR 'pv_37' phase 'a': pg=5.117 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_28`  
  IBR 'pv_28' phase 'b': pg=5.189 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_15`  
  IBR 'pv_15' phase 'a': pg=5.158 kW is within 1 % of its P bound.
