...
**Objective:** -196063.7203  
**Solve time:** 0.058 s  
**Findings:** 21 errors · 35 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 39.995 kW |
| Total load | 16.896 kW |
| Total network losses (P) | 23.099 kW |
| Total network losses (Q) | 6.69 kW var |
| Loss fraction | 136.7% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 17.845 V (bus `896`) |
...
|:--:|------|-------:|------:|------------:|------------:|--------------:|------------------:|
| ✅ | `104` | 230.0 V | 99 | 1.0 (`sourcebus`) | 1.095 (`896`) | 5.1 % (`313`) | 17.85 V (`896`) |
...
|:--:|-----|-----------:|-----------:|------------:|------------:|----------:|--------:|
| ✅ | `896` | 241.2 | 251.8 | 1.049 | 1.095 | 4.6 % | 17.85 V |
| ✅ | `949` | 241.6 | 251.3 | 1.05 | 1.093 | 4.2 % | 17.0 V |
| ✅ | `677` | 241.2 | 251.2 | 1.049 | 1.092 | 4.4 % | 17.26 V |
| ✅ | `660` | 241.2 | 251.2 | 1.049 | 1.092 | 4.3 % | 17.2 V |
| ✅ | `661` | 241.2 | 251.1 | 1.049 | 1.092 | 4.3 % | 17.08 V |
| ✅ | `895` | 241.6 | 251.1 | 1.05 | 1.092 | 4.1 % | 16.68 V |
| ✅ | `654` | 241.2 | 251.0 | 1.049 | 1.091 | 4.3 % | 16.95 V |
| ✅ | `644` | 241.2 | 251.0 | 1.049 | 1.091 | 4.3 % | 16.92 V |
| ✅ | `635` | 241.2 | 250.9 | 1.049 | 1.091 | 4.2 % | 16.83 V |
| ✅ | `904` | 241.6 | 250.9 | 1.05 | 1.091 | 4.1 % | 16.55 V |
| ✅ | `775` | 241.4 | 250.8 | 1.05 | 1.09 | 4.1 % | 16.55 V |
...
| ✅ | `665` | 241.4 | 250.4 | 1.05 | 1.089 | 3.9 % | 16.08 V |
| ✅ | `627` | 241.2 | 250.3 | 1.049 | 1.088 | 4.0 % | 16.12 V |
| ✅ | `779` | 241.4 | 250.3 | 1.05 | 1.088 | 3.9 % | 16.3 V |
...
| ✅ | `600` | 241.2 | 250.2 | 1.049 | 1.088 | 3.9 % | 15.88 V |
...
| ✅ | `568` | 241.4 | 250.1 | 1.049 | 1.087 | 3.8 % | 15.84 V |
...
| ✅ | `272` | 237.7 | 249.1 | 1.033 | 1.083 | 5.0 % | 14.66 V |
...
| ✅ | `192` | 237.8 | 247.7 | 1.034 | 1.077 | 4.3 % | 13.01 V |
...
| ✅ | `427` | 238.1 | 246.7 | 1.035 | 1.073 | 3.7 % | 8.01 V |
...
| ✅ | `128` | 238.1 | 245.6 | 1.035 | 1.068 | 3.3 % | 10.35 V |
...
| ✅ | `90` | 238.1 | 245.1 | 1.035 | 1.066 | 3.0 % | 9.75 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_22`  
  IBR 'pv_22' phase 'c': pg=5.229 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_18`  
  IBR 'pv_18' phase 'b': pg=5.232 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_13`  
  IBR 'pv_13' phase 'c': pg=5.25 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_27`  
  IBR 'pv_27' phase 'b': pg=5.125 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_23`  
  IBR 'pv_23' phase 'b': pg=5.229 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_16`  
  IBR 'pv_16' phase 'b': pg=5.205 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_8`  
  IBR 'pv_8' phase 'b': pg=5.242 kW is within 1 % of its P bound.
...
- INFO `I.SOL.NEUTRAL_SHIFT`  
  Maximum neutral terminal voltage: 17.85 V at bus '896' — reflects the neutral shift under unbalanced loading.
