...
**Solve time:** 0.056 s  
**Findings:** 22 errors · 33 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 36.454 kW |
| Total load | 12.38 kW |
| Total network losses (P) | 24.074 kW |
| Total network losses (Q) | 6.944 kW var |
| Loss fraction | 194.5% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 18.39 V (bus `896`) |
...
| ✅ | `677` | 241.4 | 251.7 | 1.049 | 1.095 | 4.5 % | 17.82 V |
| ✅ | `660` | 241.4 | 251.7 | 1.049 | 1.094 | 4.5 % | 17.74 V |
| ✅ | `661` | 241.3 | 251.6 | 1.049 | 1.094 | 4.5 % | 17.61 V |
...
| ✅ | `608` | 241.4 | 250.8 | 1.049 | 1.09 | 4.1 % | 16.56 V |
| ✅ | `779` | 241.6 | 250.8 | 1.051 | 1.09 | 4.0 % | 16.8 V |
| ✅ | `659` | 241.6 | 250.7 | 1.05 | 1.09 | 4.0 % | 16.51 V |
| ✅ | `607` | 241.4 | 250.7 | 1.049 | 1.09 | 4.1 % | 16.5 V |
...
| ✅ | `313` | 237.8 | 249.8 | 1.034 | 1.086 | 5.2 % | 15.44 V |
...
| ✅ | `192` | 238.0 | 248.2 | 1.035 | 1.079 | 4.4 % | 13.46 V |
...
| ✅ | `151` | 238.1 | 247.2 | 1.035 | 1.075 | 3.9 % | 12.23 V |
| ✅ | `473` | 238.3 | 247.1 | 1.036 | 1.075 | 3.8 % | 8.05 V |
| ✅ | `145` | 238.1 | 247.1 | 1.035 | 1.074 | 3.9 % | 12.13 V |
...
| ✅ | `441` | 240.4 | 246.8 | 1.045 | 1.073 | 2.8 % | 11.51 V |
...
| ✅ | `318` | 240.1 | 246.8 | 1.044 | 1.073 | 2.9 % | 11.45 V |
...
| ✅ | `354` | 238.3 | 246.4 | 1.036 | 1.071 | 3.5 % | 7.93 V |
| ✅ | `116` | 238.2 | 246.1 | 1.036 | 1.07 | 3.4 % | 10.85 V |
| ✅ | `521` | 238.3 | 246.0 | 1.036 | 1.07 | 3.3 % | 7.91 V |
...
| ✅ | `247` | 238.3 | 245.5 | 1.036 | 1.067 | 3.1 % | 7.94 V |
| ✅ | `226` | 238.3 | 245.5 | 1.036 | 1.067 | 3.1 % | 8.04 V |
| ✅ | `220` | 238.3 | 245.5 | 1.036 | 1.067 | 3.1 % | 8.06 V |
...
| ✅ | `147` | 238.3 | 245.4 | 1.036 | 1.067 | 3.1 % | 9.81 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_22`  
  IBR 'pv_22' phase 'c': pg=5.223 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_18`  
  IBR 'pv_18' phase 'b': pg=5.226 kW is within 1 % of its P bound.
...
- **ERROR** `E.SOL.IBR_VIOLATION` — ibr/`pv_5`  
  IBR 'pv_5' phase 'c': |S|=5.25 kW exceeds s_max=5.25 kW (apparent-power circle violated).
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_32`  
  IBR 'pv_32' phase 'a': pg=4.79 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_17`  
  IBR 'pv_17' phase 'c': pg=5.215 kW is within 1 % of its P bound.
...
- INFO `I.SOL.LOSS_FRACTION`  
  Line losses are 194.5 % of total load — unusually high; verify impedance scaling and operating point.
