...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 38.975 kW |
| Total load | 14.852 kW |
| Total network losses (P) | 24.123 kW |
| Total network losses (Q) | 6.965 kW var |
| Loss fraction | 162.4% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 18.512 V (bus `896`) |
...
| ✅ | `677` | 241.3 | 251.7 | 1.049 | 1.094 | 4.5 % | 17.94 V |
...
| ✅ | `617` | 241.3 | 250.8 | 1.049 | 1.09 | 4.1 % | 16.7 V |
...
| ✅ | `607` | 241.3 | 250.7 | 1.049 | 1.09 | 4.1 % | 16.61 V |
...
| ✅ | `773` | 241.5 | 250.6 | 1.05 | 1.089 | 3.9 % | 16.74 V |
| ✅ | `568` | 241.5 | 250.5 | 1.05 | 1.089 | 3.9 % | 16.45 V |
| ✅ | `545` | 241.3 | 250.1 | 1.049 | 1.087 | 3.8 % | 15.89 V |
| ✅ | `313` | 237.7 | 249.7 | 1.033 | 1.086 | 5.2 % | 15.54 V |
| ✅ | `303` | 237.7 | 249.7 | 1.034 | 1.086 | 5.2 % | 15.46 V |
| ✅ | `290` | 237.7 | 249.6 | 1.034 | 1.085 | 5.2 % | 15.38 V |
...
| ✅ | `229` | 237.8 | 248.5 | 1.034 | 1.081 | 4.7 % | 14.04 V |
| ✅ | `216` | 237.8 | 248.5 | 1.034 | 1.08 | 4.6 % | 13.94 V |
...
| ✅ | `439` | 238.2 | 247.0 | 1.036 | 1.074 | 3.8 % | 8.27 V |
| ✅ | `536` | 238.2 | 247.0 | 1.036 | 1.074 | 3.8 % | 8.25 V |
| ✅ | `138` | 238.0 | 246.9 | 1.035 | 1.074 | 3.9 % | 12.1 V |
| ✅ | `144` | 238.0 | 246.9 | 1.035 | 1.073 | 3.9 % | 12.04 V |
| ✅ | `427` | 238.2 | 246.8 | 1.036 | 1.073 | 3.8 % | 8.23 V |
| ✅ | `428` | 240.8 | 246.8 | 1.047 | 1.073 | 2.6 % | 11.73 V |
| ✅ | `416` | 240.8 | 246.8 | 1.047 | 1.073 | 2.6 % | 11.7 V |
| ✅ | `131` | 238.0 | 246.8 | 1.035 | 1.073 | 3.8 % | 11.96 V |
...
| ✅ | `355` | 240.5 | 246.8 | 1.045 | 1.073 | 2.8 % | 11.64 V |
...
| ✅ | `198` | 238.1 | 245.7 | 1.035 | 1.068 | 3.3 % | 10.59 V |
| ✅ | `108` | 238.1 | 245.6 | 1.035 | 1.068 | 3.2 % | 10.39 V |
| ✅ | `256` | 238.2 | 245.5 | 1.036 | 1.068 | 3.2 % | 8.14 V |
...
| ✅ | `187` | 238.2 | 245.4 | 1.036 | 1.067 | 3.1 % | 9.85 V |
| ✅ | `147` | 238.2 | 245.4 | 1.036 | 1.067 | 3.1 % | 9.93 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_9`  
  IBR 'pv_9' phase 'c': pg=5.249 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_17`  
  IBR 'pv_17' phase 'c': pg=5.219 kW is within 1 % of its P bound.
