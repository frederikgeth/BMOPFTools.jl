...
|-----------|-----|-----|----|---|
| p_nom | 92.3 | 9380.0 | 1.634 | 304 |
| q_nom | 30.3 | 3080.0 | 1.634 | 304 |
...
- **[W.OPS.IMPORT_DEPENDENT]** `network`  
  Network is heavily import-dependent: local generation capacity (0.0 MW) is less than 5% of total load (0.23 MW).
