...
**Objective:** -125676.2212  
**Solve time:** 0.052 s  
**Findings:** 17 errors · 23 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 16.683 kW |
| Total load | 6.265 kW |
| Total network losses (P) | 10.419 kW |
| Total network losses (Q) | 3.838 kW var |
| Loss fraction | 166.3% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 6.888 V (bus `92`) |
...
| ✅ | `101` | 237.4 | 244.6 | 1.032 | 1.064 | 3.2 % | 6.4 V |
| ✅ | `86` | 237.4 | 244.6 | 1.032 | 1.064 | 3.2 % | 6.42 V |
...
| ✅ | `87` | 237.4 | 243.0 | 1.032 | 1.057 | 2.4 % | 2.84 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_21`  
  IBR 'pv_21' phase 'c': pg=5.242 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_3`  
  IBR 'pv_3' phase 'c': pg=5.245 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_20`  
  IBR 'pv_20' phase 'a': pg=5.174 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_17`  
  IBR 'pv_17' phase 'c': pg=5.242 kW is within 1 % of its P bound.
