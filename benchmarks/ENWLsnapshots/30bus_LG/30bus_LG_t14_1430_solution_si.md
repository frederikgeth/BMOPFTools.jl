...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 17.495 kW |
| Total load | 7.256 kW |
| Total network losses (P) | 10.24 kW |
| Total network losses (Q) | 3.776 kW var |
| Loss fraction | 141.1% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 7.365 V (bus `95`) |
...
| ✅ | `93` | 237.1 | 242.5 | 1.031 | 1.055 | 2.3 % | 3.25 V |
...
| ✅ | `88` | 239.1 | 241.1 | 1.04 | 1.048 | 0.8 % | 4.14 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_7`  
  IBR 'pv_7' phase 'b': pg=5.217 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_1`  
  IBR 'pv_1' phase 'b': pg=5.217 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_14`  
  IBR 'pv_14' phase 'c': pg=5.243 kW is within 1 % of its P bound.
...
- INFO `I.SOL.LOSS_FRACTION`  
  Line losses are 141.1 % of total load — unusually high; verify impedance scaling and operating point.
