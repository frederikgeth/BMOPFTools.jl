...
**Objective:** -122171.1307  
**Solve time:** 0.073 s  
**Findings:** 13 errors · 26 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 18.058 kW |
| Total load | 8.241 kW |
| Total network losses (P) | 9.817 kW |
| Total network losses (Q) | 3.64 kW var |
| Loss fraction | 119.1% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 7.044 V (bus `83`) |
...
| ✅ | `101` | 237.0 | 244.1 | 1.031 | 1.061 | 3.1 % | 6.39 V |
| ✅ | `98` | 237.0 | 244.1 | 1.031 | 1.061 | 3.1 % | 6.38 V |
| ✅ | `86` | 237.0 | 243.9 | 1.031 | 1.06 | 3.0 % | 6.19 V |
| ✅ | `99` | 237.1 | 243.3 | 1.031 | 1.058 | 2.7 % | 3.86 V |
| ✅ | `102` | 237.1 | 243.3 | 1.031 | 1.058 | 2.7 % | 3.86 V |
| ✅ | `96` | 237.1 | 243.3 | 1.031 | 1.058 | 2.7 % | 3.85 V |
| ✅ | `90` | 237.1 | 243.3 | 1.031 | 1.058 | 2.7 % | 3.85 V |
| ✅ | `105` | 237.1 | 243.3 | 1.031 | 1.058 | 2.7 % | 3.84 V |
| ✅ | `84` | 237.1 | 243.0 | 1.031 | 1.056 | 2.6 % | 3.7 V |
...
| ✅ | `94` | 239.1 | 241.3 | 1.039 | 1.049 | 1.0 % | 3.96 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_14`  
  IBR 'pv_14' phase 'c': pg=5.245 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_23`  
  IBR 'pv_23' phase 'b': pg=5.225 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_10`  
  IBR 'pv_10' phase 'b': pg=5.22 kW is within 1 % of its P bound.
