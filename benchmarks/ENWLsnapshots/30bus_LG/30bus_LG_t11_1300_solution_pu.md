...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 16.152 kW |
| Total load | 6.004 kW |
| Total network losses (P) | 10.148 kW |
| Total network losses (Q) | 3.738 kW var |
| Loss fraction | 169.0% |
...
| ✅ | `102` | 237.4 | 243.3 | 1.032 | 1.058 | 2.6 % | 3.2 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_14`  
  IBR 'pv_14' phase 'c': pg=5.242 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_9`  
  IBR 'pv_9' phase 'a': pg=5.187 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_5`  
  IBR 'pv_5' phase 'b': pg=5.227 kW is within 1 % of its P bound.
