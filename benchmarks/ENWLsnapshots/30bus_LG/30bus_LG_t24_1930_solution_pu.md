...
| Total load | 24.05 kW |
| Total network losses (P) | 293.83 W |
...
| ✅ | `82` | 226.4 | 229.9 | 0.985 | 0.999 | 1.5 % | 3.38 V |
...
- **ERROR** `E.SOL.IBR_VIOLATION` — ibr/`pv_12`  
  IBR 'pv_12' phase 'a': pg=624.39 W violates [0.0 W, 624.38 W].
...
- **ERROR** `E.SOL.IBR_VIOLATION` — ibr/`pv_16`  
  IBR 'pv_16' phase 'a': pg=753.52 W violates [0.0 W, 753.51 W].
- **ERROR** `E.SOL.IBR_VIOLATION` — ibr/`pv_10`  
  IBR 'pv_10' phase 'b': pg=710.68 W violates [0.0 W, 710.67 W].
- **ERROR** `E.SOL.IBR_VIOLATION` — ibr/`pv_9`  
  IBR 'pv_9' phase 'a': pg=710.4 W violates [0.0 W, 710.39 W].
- **ERROR** `E.SOL.IBR_VIOLATION` — ibr/`pv_25`  
  IBR 'pv_25' phase 'a': pg=647.81 W violates [0.0 W, 647.8 W].
...
- **ERROR** `E.SOL.IBR_VIOLATION` — ibr/`pv_18`  
  IBR 'pv_18' phase 'c': pg=697.63 W violates [0.0 W, 697.62 W].
...
- **ERROR** `E.SOL.IBR_VIOLATION` — ibr/`pv_19`  
  IBR 'pv_19' phase 'b': pg=649.96 W violates [0.0 W, 649.95 W].
- **ERROR** `E.SOL.IBR_VIOLATION` — ibr/`pv_5`  
  IBR 'pv_5' phase 'b': pg=739.81 W violates [0.0 W, 739.8 W].
