...
| Total load | 21.55 kW |
| Total network losses (P) | 530.76 W |
| Total network losses (Q) | 157.36 W var |
| Loss fraction | 2.5% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 3.615 V (bus `85`) |
...
| ✅ | `93` | 226.8 | 227.5 | 0.986 | 0.989 | 0.3 % | 1.23 V |
...
| ✅ | `95` | 227.2 | 228.5 | 0.988 | 0.994 | 0.6 % | 0.95 V |
| ✅ | `88` | 227.2 | 228.5 | 0.988 | 0.994 | 0.6 % | 1.23 V |
| ✅ | `97` | 227.3 | 228.5 | 0.988 | 0.994 | 0.6 % | 1.22 V |
| ✅ | `106` | 227.3 | 228.5 | 0.988 | 0.994 | 0.6 % | 1.19 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_12`  
  IBR 'pv_12' phase 'a': pg=0.0 W is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_16`  
  IBR 'pv_16' phase 'a': pg=0.0 W is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_10`  
  IBR 'pv_10' phase 'b': pg=0.0 W is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_9`  
  IBR 'pv_9' phase 'a': pg=0.0 W is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_25`  
  IBR 'pv_25' phase 'a': pg=0.0 W is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_18`  
  IBR 'pv_18' phase 'c': pg=0.0 W is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_19`  
  IBR 'pv_19' phase 'b': pg=0.0 W is within 1 % of its P bound.
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_5`  
  IBR 'pv_5' phase 'b': pg=0.0 W is within 1 % of its P bound.
