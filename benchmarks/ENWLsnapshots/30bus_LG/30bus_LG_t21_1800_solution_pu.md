...
| Total network losses (P) | 1.762 kW |
| Total network losses (Q) | 671.38 W var |
| Loss fraction | 8.0% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 3.646 V (bus `104`) |
...
|:--:|------|-------:|------:|------------:|------------:|--------------:|------------------:|
| ✅ | `100` | 230.0 V | 30 | 1.0 (`sourcebus`) | 1.029 (`104`) | 1.9 % (`104`) | 3.65 V (`104`) |
...
|:--:|-----|-----------:|-----------:|------------:|------------:|----------:|--------:|
| ✅ | `104` | 232.1 | 236.6 | 1.009 | 1.029 | 1.9 % | 3.65 V |
| ✅ | `107` | 232.1 | 236.6 | 1.009 | 1.029 | 1.9 % | 3.65 V |
| ✅ | `99` | 232.2 | 236.4 | 1.009 | 1.028 | 1.8 % | 3.44 V |
| ✅ | `89` | 232.1 | 236.4 | 1.009 | 1.028 | 1.8 % | 3.49 V |
| ✅ | `95` | 232.1 | 236.3 | 1.009 | 1.028 | 1.8 % | 3.45 V |
| ✅ | `83` | 232.1 | 236.3 | 1.009 | 1.028 | 1.8 % | 3.43 V |
| ✅ | `87` | 232.2 | 236.3 | 1.009 | 1.028 | 1.8 % | 3.35 V |
| ✅ | `102` | 232.2 | 236.3 | 1.009 | 1.027 | 1.8 % | 3.33 V |
| ✅ | `92` | 232.1 | 236.3 | 1.009 | 1.027 | 1.8 % | 3.37 V |
| ✅ | `90` | 232.2 | 236.2 | 1.009 | 1.027 | 1.8 % | 3.28 V |
| ✅ | `81` | 232.2 | 236.0 | 1.009 | 1.026 | 1.7 % | 3.1 V |
| ✅ | `96` | 232.2 | 236.0 | 1.009 | 1.026 | 1.7 % | 3.08 V |
| ✅ | `105` | 232.2 | 236.0 | 1.009 | 1.026 | 1.6 % | 3.05 V |
| ✅ | `101` | 232.2 | 235.8 | 1.009 | 1.025 | 1.6 % | 2.87 V |
| ✅ | `84` | 232.2 | 235.5 | 1.009 | 1.024 | 1.4 % | 2.87 V |
| ✅ | `86` | 232.2 | 235.0 | 1.009 | 1.022 | 1.3 % | 2.09 V |
| ✅ | `98` | 232.2 | 235.0 | 1.009 | 1.022 | 1.2 % | 2.02 V |
| ✅ | `93` | 232.2 | 234.8 | 1.009 | 1.021 | 1.1 % | 2.6 V |
| ✅ | `80` | 232.2 | 234.8 | 1.009 | 1.021 | 1.1 % | 1.84 V |
| ✅ | `97` | 234.2 | 234.4 | 1.018 | 1.019 | 0.1 % | 0.54 V |
| ✅ | `91` | 234.2 | 234.4 | 1.018 | 1.019 | 0.1 % | 0.49 V |
| ✅ | `100` | 234.2 | 234.4 | 1.018 | 1.019 | 0.1 % | 0.43 V |
| ✅ | `106` | 234.1 | 234.4 | 1.018 | 1.019 | 0.1 % | 0.34 V |
| ✅ | `88` | 234.1 | 234.4 | 1.018 | 1.019 | 0.1 % | 0.32 V |
| ✅ | `94` | 233.6 | 234.4 | 1.016 | 1.019 | 0.4 % | 0.39 V |
| ✅ | `103` | 232.9 | 234.4 | 1.013 | 1.019 | 0.6 % | 1.0 V |
| ✅ | `79` | 232.2 | 234.4 | 1.009 | 1.019 | 0.9 % | 1.82 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_11`  
  IBR 'pv_11' phase 'a': pg=2.611 kW is within 1 % of its P bound.
...
- INFO `I.SOL.NEUTRAL_SHIFT`  
  Maximum neutral terminal voltage: 3.65 V at bus '104' — reflects the neutral shift under unbalanced loading.
