...
**Objective:** -120884.1847  
**Solve time:** 0.053 s  
**Findings:** 5 errors · 27 warnings · 3 info  
...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 15.488 kW |
| Total load | 5.868 kW |
| Total network losses (P) | 9.62 kW |
| Total network losses (Q) | 3.549 kW var |
| Loss fraction | 163.9% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 7.482 V (bus `95`) |
...
| ✅ | `92` | 236.8 | 244.5 | 1.03 | 1.063 | 3.3 % | 7.1 V |
...
| ✅ | `87` | 236.9 | 243.2 | 1.03 | 1.057 | 2.7 % | 3.84 V |
...
| ✅ | `91` | 239.0 | 240.8 | 1.039 | 1.047 | 0.8 % | 3.92 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_15`  
  IBR 'pv_15' phase 'a': pg=5.181 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_19`  
  IBR 'pv_19' phase 'b': pg=5.221 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_27`  
  IBR 'pv_27' phase 'a': pg=5.191 kW is within 1 % of its P bound.
