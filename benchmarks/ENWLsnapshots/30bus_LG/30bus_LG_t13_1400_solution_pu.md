...
|-------|-------|
| Status | `LOCALLY_SOLVED` |
| Total generation | 17.047 kW |
| Total load | 6.655 kW |
| Total network losses (P) | 10.392 kW |
| Total network losses (Q) | 3.815 kW var |
| Loss fraction | 156.2% |
| Active power balance error | 0.0 W |
| Reactive power balance error | 0.0 W var |
| Max neutral shift | 7.401 V (bus `95`) |
...
| ✅ | `88` | 239.1 | 241.2 | 1.039 | 1.049 | 0.9 % | 4.64 V |
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_21`  
  IBR 'pv_21' phase 'c': pg=5.244 kW is within 1 % of its P bound.
...
- **WARN** `W.SOL.IBR_ACTIVE` — ibr/`pv_8`  
  IBR 'pv_8' phase 'c': pg=5.248 kW is within 1 % of its P bound.
...
- INFO `I.SOL.LOSS_FRACTION`  
  Line losses are 156.2 % of total load — unusually high; verify impedance scaling and operating point.
