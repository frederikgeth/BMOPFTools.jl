...
**Findings:** 0 errors · 3 warnings · 68 info  
...
| generator | 12 | capacity: 288.915 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 984 / 984 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 984 |
| Neutral branches | 983 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 984 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 983 / 0 / 0 |
...
**Total findings:** 71 (0 errors, 3 warnings, 68 info)
