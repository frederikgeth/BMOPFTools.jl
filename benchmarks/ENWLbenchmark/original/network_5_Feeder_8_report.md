# BMOPF Network Summary: network_5_Feeder_8

**Generated:** 2026-06-23 13:44:08  
**Findings:** 0 errors · 7 warnings · 59 info  
...
| generator | 11 | capacity: 222.131 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000259 | 0.00228 | 0.762 | 5 |
...
| Total gen capacity | 222.131 kW |
| Generation/load ratio | 731.8% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 469 / 469 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 469 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 469 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 468 / 0 / 0 |
...
**Total findings:** 66 (0 errors, 7 warnings, 59 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line7`  
  Line 'line7' has ||Z||_F = 9.44e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line5`  
  Line 'line5' has ||Z||_F = 8.28e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line4`  
  Line 'line4' has ||Z||_F = 8.28e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line6`  
  Line 'line6' has ||Z||_F = 9.44e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
