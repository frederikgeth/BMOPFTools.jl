# BMOPF Network Summary: network_4_Feeder_6

**Generated:** 2026-06-23 13:44:03  
**Findings:** 0 errors · 3 warnings · 56 info  
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000322 | 0.00228 | 0.675 | 6 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 399 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 398 / 0 / 0 |
...
**Total findings:** 59 (0 errors, 3 warnings, 56 info)
