# BMOPF Network Summary: network_18_Feeder_3

**Generated:** 2026-06-23 13:43:34  
**Findings:** 0 errors · 6 warnings · 92 info  
...
| generator | 14 | capacity: 354.839 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
|-------|---------|------:|------:|------:|-----------:|
| LV_240V | 240.0 V | 1491 | 1490 | 51 | 14 |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| p_max | 4000.0 | 101000.0 | 1.762 | 16 |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000564 | 0.00228 | 0.634 | 6 |
...
| Total gen capacity | 354.839 kW |
| Generation/load ratio | 703.0% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 1491 / 1491 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 1491 |
| Neutral branches | 1490 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 1491 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 1490 / 0 / 0 |
...
**Total findings:** 98 (0 errors, 6 warnings, 92 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line1242`  
  Line 'line1242' has ||Z||_F = 5.74e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line964`  
  Line 'line964' has ||Z||_F = 8.2e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line69`  
  Line 'line69' has ||Z||_F = 9.44e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
