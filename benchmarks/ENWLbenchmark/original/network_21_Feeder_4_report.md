# BMOPF Network Summary: network_21_Feeder_4

**Generated:** 2026-06-23 13:43:45  
**Findings:** 0 errors · 4 warnings · 80 info  
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 385 / 385 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 385 |
| Neutral branches | 384 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 385 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 384 / 0 / 0 |
...
**Total findings:** 84 (0 errors, 4 warnings, 80 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line20`  
  Line 'line20' has ||Z||_F = 9.25e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
