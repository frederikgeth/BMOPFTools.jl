# BMOPF Network Summary: network_7_Feeder_3

**Generated:** 2026-06-23 13:44:14  
**Findings:** 0 errors · 4 warnings · 45 info  
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000322 | 0.00228 | 0.783 | 5 |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 417 / 417 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 417 |
| Neutral branches | 416 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 417 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 416 / 0 / 0 |
...
**Total findings:** 49 (0 errors, 4 warnings, 45 info)
...
- **[W.DOM.LINE_LOW_IMPEDANCE]** `line17`  
  Line 'line17' has ||Z||_F = 9.35e-5 Ω < threshold 0.0001 Ω — near-zero series impedance; consider replacing with a switch object to avoid ill-conditioned KVL constraints.
