# BMOPF Network Summary: network_5_Feeder_7
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| R_series_1_1 | 0.000564 | 0.00228 | 0.614 | 3 |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 320 / 320 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 320 |
| Neutral branches | 319 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 320 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 319 / 0 / 0 |
