# BMOPF Network Summary: network_10_Feeder_3
...
| generator | 5 | capacity: 115.792 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Total gen capacity | 115.792 kW |
| Generation/load ratio | 696.2% |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 38 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 37 / 0 / 0 |
