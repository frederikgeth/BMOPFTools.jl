# BMOPF Network Summary: network_20_Feeder_3
...
| generator | 16 | capacity: 381.977 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| p_max | 4000.0 | 107000.0 | 1.867 | 18 |
...
| Total gen capacity | 381.977 kW |
| Generation/load ratio | 711.8% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 92 / 92 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 92 |
| Neutral branches | 91 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 92 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 91 / 0 / 0 |
