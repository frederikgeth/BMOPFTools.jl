# BMOPF Network Summary: network_22_Feeder_4
...
| Total gen capacity | 170.2 kW |
| Generation/load ratio | 718.1% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 54 / 54 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 54 |
| Neutral branches | 53 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 54 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 53 / 0 / 0 |
