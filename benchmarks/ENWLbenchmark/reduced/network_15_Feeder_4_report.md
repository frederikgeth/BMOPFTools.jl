# BMOPF Network Summary: network_15_Feeder_4
...
| generator | 36 | capacity: 832.633 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
|-------|---------|------:|------:|------:|-----------:|
| LV_240V | 240.0 V | 247 | 246 | 138 | 36 |
...
| Total gen capacity | 832.633 kW |
| Generation/load ratio | 721.3% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 247 / 247 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 247 |
| Neutral branches | 246 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 247 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 246 / 0 / 0 |
