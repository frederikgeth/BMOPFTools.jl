...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 147 / 147 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 147 |
| Neutral branches | 146 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 147 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 146 / 0 / 0 |
...
- **[I.RED.MERGEABLE_LINES]** `line`  
  13 group(s) of series lines (30 lines total) can be merged — intermediate buses have no other connections.
