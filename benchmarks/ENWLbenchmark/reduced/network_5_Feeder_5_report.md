...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 102 / 102 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 102 |
| Neutral branches | 101 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 102 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 101 / 0 / 0 |
