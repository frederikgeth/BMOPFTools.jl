# BMOPF Network Summary: network_16_Feeder_3
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 139 / 139 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 139 |
| Neutral branches | 138 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 139 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 138 / 0 / 0 |
