# BMOPF Network Summary: network_5_Feeder_1
...
| generator | 2 | capacity: 37.228 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Total gen capacity | 37.228 kW |
| Generation/load ratio | 672.2% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 11 / 11 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 11 |
| Neutral branches | 10 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 11 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 10 / 0 / 0 |
