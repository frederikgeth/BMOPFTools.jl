...
| generator | 45 | capacity: 1.105 MW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
|-------|---------|------:|------:|------:|-----------:|
| LV_240V | 240.0 V | 358 | 357 | 175 | 45 |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| p_max | 4000.0 | 310000.0 | 3.213 | 47 |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 358 / 358 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 358 |
| Neutral branches | 357 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 358 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 357 / 0 / 0 |
