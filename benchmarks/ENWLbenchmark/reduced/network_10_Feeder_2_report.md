...
| Total gen capacity | 49.22 kW |
| Generation/load ratio | 716.4% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 10 / 10 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 10 |
| Neutral branches | 9 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 10 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 9 / 0 / 0 |
