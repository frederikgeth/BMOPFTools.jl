# BMOPF Network Summary: network_5_Feeder_4
...
| generator | 9 | capacity: 181.148 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Total gen capacity | 181.148 kW |
| Generation/load ratio | 728.7% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 64 / 64 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 64 |
| Neutral branches | 63 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 64 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 63 / 0 / 0 |
