...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 134 / 134 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 134 |
| Neutral branches | 133 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 134 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 133 / 0 / 0 |
