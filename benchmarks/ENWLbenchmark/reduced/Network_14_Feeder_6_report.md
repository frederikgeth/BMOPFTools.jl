# BMOPF Network Summary: Network_14_Feeder_6
...
| generator | 12 | capacity: 302.055 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Total gen capacity | 302.055 kW |
| Generation/load ratio | 702.3% |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 46 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 45 / 0 / 0 |
