# BMOPF Network Summary: network_2_Feeder_3
...
| generator | 29 | capacity: 703.61 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
|-------|---------|------:|------:|------:|-----------:|
| LV_240V | 240.0 V | 222 | 221 | 112 | 29 |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| p_max | 4000.0 | 197000.0 | 2.558 | 31 |
...
| Total gen capacity | 703.61 kW |
| Generation/load ratio | 713.6% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 222 / 222 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 222 |
| Neutral branches | 221 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 222 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 221 / 0 / 0 |
