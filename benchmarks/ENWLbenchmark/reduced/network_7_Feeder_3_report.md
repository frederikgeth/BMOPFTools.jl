...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 104 / 104 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 104 |
| Neutral branches | 103 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 104 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 103 / 0 / 0 |
