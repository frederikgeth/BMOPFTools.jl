...
| generator | 57 | capacity: 1.372 MW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
|-------|---------|------:|------:|------:|-----------:|
| LV_240V | 240.0 V | 435 | 434 | 223 | 57 |
...
| Parameter | Min | Max | CV | n |
|-----------|-----|-----|----|---|
| p_max | 4000.0 | 383000.0 | 3.608 | 59 |
...
| Total gen capacity | 1.372 MW |
| Generation/load ratio | 717.1% |
...
|---------------|-------|-------------------:|
| LV_240V | 4-wire | 435 / 435 |

| Neutral grounding | Value |
|-------------------|------:|
| Buses with neutral | 435 |
| Neutral branches | 434 |
| Grounding points | 1 |
| Neutral sections | 1 |
| Floating sections | 0 |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 435 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 434 / 0 / 0 |
