# BMOPF Network Summary: network_4_Feeder_2
...
| generator | 5 | capacity: 116.476 kW |
| shunt | 1 |  |
| switch | 0 |  |
| transformer | 0 |  |
...
| Total gen capacity | 116.476 kW |
| Generation/load ratio | 695.5% |
...
|------|------:|-------|------------|------------------:|---------------|
| 240.0 V | 35 | 4-wire | solid | 0 | TN-S or TT (source-earthed only — protective-earth side not representable in the data model) |
...
| Buses with vpn / vpp / vpos bounds | 34 / 0 / 0 |
